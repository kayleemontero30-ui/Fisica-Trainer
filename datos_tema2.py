...
TEMA2 = {'nombre': 'Tema 2 - Campo magnetostático',
 'resumen': '\n'
 ...
 'formulas': [{'nombre': 'Fuerza magnética sobre una carga',
               ...
               'sale_de': ['Experimentalmente, la fuerza magnética depende de la carga, la velocidad y el campo '
                           'magnético.',
               ...
               'despejes': ['|q| = F/(vBsin(theta))',
                            'v = F/(|q|Bsin(theta))',
                            'B = F/(|q|v sin(theta))',
                            'sin(theta)=F/(|q|vB)'],
               'formulas_relacionadas': ['F_c = mv²/r', 'r = mv/(|q|B)', 'F = I L × B', 'Phi_B = BAcos(theta)'],
               'uso': 'Calcular fuerza magnética sobre una partícula cargada en movimiento.',
               'cuando_usarla': ['Cuando aparece una carga q moviéndose con velocidad v en un campo B.',
                                 'Cuando piden dirección de la fuerza magnética.',
                                 'Cuando se habla de trayectoria circular o desviación de partículas.'],
               'procedimiento': ['Identifica q, v, B y el ángulo entre v y B.',
               ...
               'detalles': ['Si v es paralela a B, la fuerza es cero.',
                            'Si v es perpendicular a B, la fuerza es máxima.',
                            'La fuerza magnética no realiza trabajo porque es perpendicular al desplazamiento '
                            'instantáneo.'],
               'errores_tipicos': ['Olvidar el sin(theta).',
               ...
               'mini_ejemplo': {'enunciado': 'Una carga positiva se mueve hacia la derecha y B entra en la pantalla.',
                                'pasos': ['v apunta hacia +x.',
               ...
               'latex_base': '$\\vec F=q\\,\\vec v\\times\\vec B$',
               'latex_principal': '$|\\vec F|=|q|vB\\sin\\theta$',
               'latex_despejes': ['$B=\\frac{F}{|q|v\\sin\\theta}$', '$v=\\frac{F}{|q|B\\sin\\theta}$']},
              {'nombre': 'Movimiento circular de una carga en B uniforme',
               ...
               'sale_de': ['La fuerza magnética para v perpendicular a B es F=|q|vB.',
               ...
               'despejes': ['m = r|q|B/v', 'v = r|q|B/m', '|q| = mv/(rB)', 'B = mv/(r|q|)'],
               'formulas_relacionadas': ['F = q v × B', 'F_c = mv²/r', 'omega = |q|B/m', 'T = 2πm/(|q|B)'],
               'uso': 'Resolver trayectorias circulares de partículas cargadas en campos magnéticos.',
               'cuando_usarla': ['Cuando el enunciado menciona radio de trayectoria.',
                                 'Cuando una partícula entra perpendicularmente a B.',
                                 'Cuando piden masa, carga, velocidad o campo a partir de la curvatura.'],
               'procedimiento': ['Comprueba que v sea perpendicular a B.',
                                 'Escribe F_magnética=F_centrípeta.',
                                 'Sustituye |q|vB=mv²/r.',
                                 'Despeja la magnitud pedida.'],
               'detalles': ['El campo magnético cambia la dirección de v, no su módulo.',
                            'Si hay componente paralela a B, la trayectoria es helicoidal.',
                            'El radio aumenta con masa y velocidad.'],
               'errores_tipicos': ['Usar energía cinética como si el campo hiciera trabajo.',
                                   'Olvidar simplificar una v.',
                                   'No usar valor absoluto de la carga para el radio.'],
               'latex_base': '$|q|vB=\\frac{mv^2}{r}$',
               'latex_principal': '$r=\\frac{mv}{|q|B}$',
               'latex_despejes': ['$B=\\frac{mv}{|q|r}$', '$v=\\frac{|q|Br}{m}$']},
              {'nombre': 'Frecuencia angular ciclotrón',
               'idea_clave': 'La frecuencia de giro de una carga en B uniforme no depende de la velocidad si el modelo '
                             'es no relativista.',
               'formula_base': 'omega = v/r',
               'formula_principal': 'omega = |q|B/m',
               'sale_de': ['Para movimiento circular, omega=v/r.',
                           'Del radio magnético r=mv/(|q|B).',
                           'Sustituyendo: omega=v/(mv/(|q|B))=|q|B/m.'],
               'despejes': ['|q| = omega m/B', 'B = omega m/|q|', 'm = |q|B/omega', 'T = 2π/omega = 2πm/(|q|B)'],
               'formulas_relacionadas': ['r = mv/(|q|B)', 'F = |q|vB', 'f = omega/(2π)'],
               'uso': 'Problemas de partículas cargadas girando en campos magnéticos.',
               'cuando_usarla': ['Cuando piden periodo, frecuencia o velocidad angular.',
                                 'Cuando aparece movimiento circular en B uniforme.',
                                 'Cuando se comparan partículas por masa/carga.'],
               'procedimiento': ['Identifica q, m y B.',
                                 'Usa omega=|q|B/m.',
                                 'Si piden periodo, usa T=2π/omega.',
                                 'Si piden frecuencia, usa f=omega/(2π).'],
               'errores_tipicos': ['Meter la velocidad en omega cuando no hace falta.',
                                   'Olvidar el valor absoluto de q.',
                                   'Confundir frecuencia angular omega con frecuencia f.'],
               'latex_base': '$\\omega=\\frac{v}{r}$',
               'latex_principal': '$\\omega=\\frac{|q|B}{m}$',
               'latex_despejes': ['$T=\\frac{2\\pi}{\\omega}=\\frac{2\\pi m}{|q|B}$', '$f=\\frac{\\omega}{2\\pi}$']},
              {'nombre': 'Fuerza magnética sobre un conductor',
               'idea_clave': 'Un conductor con corriente en un campo magnético siente fuerza porque sus cargas se '
                             'mueven.',
               'formula_base': 'F = I L × B',
               'formula_principal': '|F| = I L B sin(theta)',
               'sale_de': ['Una corriente es movimiento organizado de cargas.',
                           'Cada carga móvil siente fuerza magnética qv×B.',
                           'Al sumar el efecto sobre todas las cargas del tramo se obtiene F=IL×B.'],
               'despejes': ['I = F/(LBsin(theta))',
                            'L = F/(IBsin(theta))',
                            'B = F/(ILsin(theta))',
                            'sin(theta)=F/(ILB)'],
               'formulas_relacionadas': ['F = q v × B', 'Torque en espira: tau=mu×B', 'F/L = μ0 I1 I2/(2πd)'],
               'uso': 'Calcular fuerza sobre un alambre con corriente dentro de un campo magnético.',
               'cuando_usarla': ['Cuando hay un conductor recto de longitud L con corriente I.',
                                 'Cuando el conductor está dentro de un campo magnético B.',
                                 'Cuando piden dirección de fuerza sobre un cable.'],
               'procedimiento': ['Identifica la dirección de la corriente.',
                                 'Toma L en dirección de la corriente.',
                                 'Calcula módulo con ILBsin(theta).',
                                 'Usa regla de la mano derecha para L×B.'],
               'detalles': ['Si el conductor es paralelo a B, no hay fuerza.',
                            'Si es perpendicular, la fuerza es máxima.',
                            'La dirección del vector L sigue la corriente convencional.'],
               'errores_tipicos': ['Usar la longitud total aunque solo una parte esté dentro de B.',
                                   'Usar L como escalar sin dirección al buscar sentido.',
                                   'Olvidar el ángulo entre corriente y campo.'],
               'latex_base': '$\\vec F=I\\vec L\\times\\vec B$',
               'latex_principal': '$F=ILB\\sin\\theta$',
               'latex_despejes': ['$I=\\frac{F}{LB\\sin\\theta}$', '$B=\\frac{F}{IL\\sin\\theta}$']},
              {'nombre': 'Campo magnético de un hilo recto largo',
               ...
               'sale_de': ['Se usa una trayectoria amperiana circular de radio r centrada en el hilo.',
               ...
               'despejes': ['I = B(2πr)/μ0', 'r = μ0I/(2πB)', 'μ0 = B(2πr)/I'],
               'formulas_relacionadas': ['Ley de Ampère: ∮B·dl=μ0I_enc', 'F = IL×B', 'F/L = μ0I1I2/(2πd)'],
               'uso': 'Calcular el campo alrededor de un hilo recto muy largo.',
               'cuando_usarla': ['Cuando el problema dice hilo recto largo o conductor infinito.',
                                 'Cuando piden B a distancia r del hilo.',
                                 'Cuando se estudian fuerzas entre hilos paralelos.'],
               'procedimiento': ['Identifica I y la distancia r.',
                                 'Calcula B=μ0I/(2πr).',
                                 'Usa la regla de la mano derecha para el sentido.',
                                 'Dibuja líneas circulares alrededor del hilo.'],
               'detalles': ['B disminuye como 1/r.',
                            'Las líneas de B no salen radialmente; rodean al hilo.',
                            'μ0=4π×10^-7 T·m/A.'],
               'errores_tipicos': ['Dibujar B saliendo del hilo como si fuera campo eléctrico.',
                                   'Confundir r con diámetro.',
                                   'Olvidar el factor 2π.'],
               'latex_base': '$\\oint\\vec B\\cdot d\\vec l=\\mu_0I_{\\mathrm{enc}}$',
               'latex_principal': '$B=\\frac{\\mu_0I}{2\\pi r}$',
               'latex_despejes': ['$I=\\frac{2\\pi rB}{\\mu_0}$', '$r=\\frac{\\mu_0I}{2\\pi B}$']},
              {'nombre': 'Fuerza entre dos hilos paralelos',
               ...
               'sale_de': ['El campo creado por el hilo 1 a distancia d es B1=μ0I1/(2πd).',
                           'El hilo 2 con corriente I2 siente fuerza F=I2 L B1.',
                           'Dividiendo entre L: F/L=I2B1=μ0I1I2/(2πd).'],
               'despejes': ['I1 = (F/L)(2πd)/(μ0I2)', 'I2 = (F/L)(2πd)/(μ0I1)', 'd = μ0I1I2/(2π(F/L))'],
               'formulas_relacionadas': ['B = μ0I/(2πr)', 'F = IL×B', 'Regla de la mano derecha'],
               'uso': 'Calcular atracción o repulsión entre corrientes paralelas.',
               'cuando_usarla': ['Cuando hay dos hilos largos paralelos.',
                                 'Cuando piden fuerza por unidad de longitud.',
                                 'Cuando preguntan si se atraen o repelen.'],
               'procedimiento': ['Identifica I1, I2 y distancia d.',
                                 'Calcula F/L.',
                                 'Mismo sentido de corriente: atracción.',
                                 'Sentidos opuestos: repulsión.'],
               'detalles': ['El resultado se da por unidad de longitud si no se especifica L.',
                            'Este fenómeno se usa para definir el ampere en formulaciones clásicas.'],
               'errores_tipicos': ['Decir que mismo sentido se repelen.',
                                   'Usar r² en vez de d.',
                                   'Olvidar que es fuerza por longitud.'],
               'latex_base': '$F=ILB$',
               'latex_principal': '$\\frac{F}{L}=\\frac{\\mu_0I_1I_2}{2\\pi d}$',
               'latex_despejes': ['$d=\\frac{\\mu_0I_1I_2}{2\\pi(F/L)}$', '$I_1=\\frac{(F/L)2\\pi d}{\\mu_0I_2}$']},
              {'nombre': 'Flujo magnético',
               ...
               'sale_de': ['El flujo cuenta la componente de B perpendicular a la superficie.',
               ...
               'latex_despejes': ['$B=\\frac{\\Phi_B}{A\\cos\\theta}$', '$A=\\frac{\\Phi_B}{B\\cos\\theta}$']},
              {'nombre': 'Ley de Biot-Savart',
               ...
               'sale_de': ['Un elemento de corriente I dl produce una pequeña contribución dB.',
               ...
               'latex_base': '$d\\vec B=\\frac{\\mu_0}{4\\pi}\\frac{I\\,d\\vec l\\times\\hat r}{r^2}$',
               'latex_principal': '$dB=\\frac{\\mu_0}{4\\pi}\\frac{I\\,dl\\sin\\theta}{r^2}$',
               'latex_despejes': ['$\\vec B=\\int d\\vec B$', '$B_{\\mathrm{arco}}=\\frac{\\mu_0I\\phi}{4\\pi R}$']},
              {'nombre': 'Campo en el centro de una espira circular',
               'idea_clave': 'Una espira circular con corriente produce un campo perpendicular al plano de la espira '
                             'en su centro.',
               'formula_base': 'dB = (μ0/4π) I dl/R²',
               'formula_principal': 'B = μ0 I/(2R)',
               'sale_de': ['En el centro de la espira, todos los elementos dl están a distancia R.',
               ...
               'despejes': ['I = 2RB/μ0', 'R = μ0I/(2B)', 'Para N espiras: B = μ0NI/(2R)'],
               'formulas_relacionadas': ['Biot-Savart', 'Momento magnético μ=NIA', 'Torque τ=μBsin(theta)'],
               'uso': 'Calcular campo en el centro de una espira o bobina circular.',
               'cuando_usarla': ['Cuando el punto está en el centro de una espira.',
                                 'Cuando te dan radio R y corriente I.',
                                 'Cuando hay N vueltas iguales.'],
               'procedimiento': ['Identifica R, I y número de espiras N.',
                                 'Usa B=μ0NI/(2R) si hay N espiras.',
                                 'Determina sentido con regla de la mano derecha.'],
               'detalles': ['El campo es perpendicular al plano de la espira.',
               ...
               'errores_tipicos': ['Usar la fórmula del hilo recto.',
                                   'Olvidar multiplicar por N.',
                                   'Confundir diámetro con radio.'],
               'latex_base': '$dB=\\frac{\\mu_0}{4\\pi}\\frac{I\\,dl}{R^2}$',
               'latex_principal': '$B=\\frac{\\mu_0I}{2R}$',
               'latex_despejes': ['$B=\\frac{\\mu_0NI}{2R}$', '$I=\\frac{2RB}{\\mu_0N}$']},
              {'nombre': 'Campo de un arco circular en el centro',
               ...
               'sale_de': ['El campo de una espira completa en el centro es μ0I/(2R).',
                           'Un arco de ángulo phi representa la fracción phi/(2π) de la circunferencia.',
                           'Entonces B=(phi/(2π))(μ0I/(2R))=μ0Iphi/(4πR).'],
               'despejes': ['I = 4πRB/(μ0phi)', 'phi = 4πRB/(μ0I)', 'R = μ0Iphi/(4πB)'],
               'formulas_relacionadas': ['Biot-Savart', 'B espira = μ0I/(2R)', 'Superposición de campos magnéticos'],
               'uso': 'Campos en el centro de arcos de circunferencia.',
               'cuando_usarla': ['Cuando hay un arco circular de radio R.',
                                 'Cuando el punto está en el centro del arco.',
                                 'Cuando el ángulo del arco está dado.'],
               'procedimiento': ['Convierte el ángulo a radianes.',
                                 'Usa B=μ0Iphi/(4πR).',
                                 'Determina el sentido con regla de la mano derecha.',
                                 'Suma contribuciones si hay varios arcos.'],
               'errores_tipicos': ['Usar grados en vez de radianes.',
                                   'Olvidar que tramos radiales pueden no aportar en el centro si dl es paralelo a '
                                   'r_hat.',
                                   'No sumar sentidos correctamente.'],
               'latex_base': '$B_{\\mathrm{arco}}=\\frac{\\phi}{2\\pi}B_{\\mathrm{espira}}$',
               'latex_principal': '$B=\\frac{\\mu_0I\\phi}{4\\pi R}$',
               'latex_despejes': ['$I=\\frac{4\\pi RB}{\\mu_0\\phi}$', '$\\phi=\\frac{4\\pi RB}{\\mu_0I}$']},
              {'nombre': 'Ley de Ampère',
               'idea_clave': 'Relaciona la circulación de B con la corriente encerrada.',
               'formula_base': '∮ B · dl = μ0 I_enc',
               'formula_principal': '∮ B · dl = μ0 I_enc',
               'sale_de': ['Para corrientes estacionarias, el campo magnético rodea corrientes.',
                           'La integral cerrada de B a lo largo de una curva mide esa circulación.',
                           'Ampère dice que esa circulación depende de la corriente neta atravesando la superficie '
                           'limitada por la curva.'],
               'despejes': ['I_enc = (1/μ0)∮B·dl',
                            'B = μ0I_enc/(longitud de trayectoria) si B es constante y paralelo a dl',
                            'Para circunferencia: B = μ0I_enc/(2πr)'],
               'formulas_relacionadas': ['B hilo largo = μ0I/(2πr)', 'B solenoide = μ0nI', 'B toroide = μ0NI/(2πr)'],
               'uso': 'Calcular B cuando hay simetría suficiente.',
               'cuando_usarla': ['Hilo recto largo.',
                                 'Solenoide ideal.',
                                 'Toroide.',
                                 'Conductor cilíndrico largo.',
                                 'Cuando el enunciado menciona trayectoria amperiana.'],
               'procedimiento': ['Identifica la simetría del problema.',
                                 'Elige una trayectoria amperiana adecuada.',
                                 'Determina I_enc.',
                                 'Simplifica ∮B·dl.',
                                 'Despeja B.'],
               'detalles': ['Ampère siempre es válida en magnetostática, pero no siempre permite despejar B '
                            'fácilmente.',
                            'La corriente encerrada puede ser positiva o negativa según orientación.',
                            'Se parece a Gauss en el uso de simetría.'],
               'errores_tipicos': ['Usar Ampère sin simetría.',
               ...
               'latex_base': '$\\oint\\vec B\\cdot d\\vec l=\\mu_0I_{\\mathrm{enc}}$',
               'latex_principal': '$\\oint\\vec B\\cdot d\\vec l=\\mu_0I_{\\mathrm{enc}}$',
               'latex_despejes': ['$I_{\\mathrm{enc}}=\\frac{1}{\\mu_0}\\oint\\vec B\\cdot d\\vec l$',
                                  '$B=\\frac{\\mu_0I_{\\mathrm{enc}}}{2\\pi r}$']},
              {'nombre': 'Campo dentro de un solenoide ideal',
               ...
               'sale_de': ['Se aplica Ampère a una trayectoria rectangular que pasa por dentro y fuera del solenoide.',
               ...
               'latex_base': '$\\oint\\vec B\\cdot d\\vec l=\\mu_0I_{\\mathrm{enc}}$',
               'latex_principal': '$B=\\mu_0nI$',
               'latex_despejes': ['$n=\\frac{N}{L}$', '$I=\\frac{B}{\\mu_0n}$']},
              {'nombre': 'Campo dentro de un toroide',
               ...
               'sale_de': ['Se usa una trayectoria amperiana circular de radio r dentro del toroide.',
               ...
               'despejes': ['N = B(2πr)/(μ0I)', 'I = B(2πr)/(μ0N)', 'r = μ0NI/(2πB)'],
               'formulas_relacionadas': ['Ley de Ampère', 'Solenoide ideal B=μ0nI', 'Flujo magnético'],
               'uso': 'Calcular campo magnético en toroides.',
               'cuando_usarla': ['Cuando el enunciado dice toroide.',
                                 'Cuando hay N vueltas alrededor de un núcleo circular.',
                                 'Cuando piden B a un radio r dentro del toroide.'],
               'procedimiento': ['Elige circunferencia amperiana dentro del toroide.',
                                 'Determina r.',
                                 'Usa B=μ0NI/(2πr).',
                                 'Fuera del toroide ideal, el campo se suele aproximar como cero.'],
               'errores_tipicos': ['Usar n=N/L como en solenoide recto.',
                                   'Olvidar que B depende de r.',
                                   'Usar radio exterior/interior equivocado si el problema especifica una posición.'],
               'latex_base': '$B(2\\pi r)=\\mu_0NI$',
               'latex_principal': '$B=\\frac{\\mu_0NI}{2\\pi r}$',
               'latex_despejes': ['$I=\\frac{2\\pi rB}{\\mu_0N}$', '$N=\\frac{2\\pi rB}{\\mu_0I}$']},
              ...
              {'nombre': 'Torque sobre una espira en campo magnético',
               ...
               'sale_de': ['Los lados opuestos de una espira con corriente pueden sentir fuerzas magnéticas opuestas.',
                           'Estas fuerzas forman un par de fuerzas.',
                           'Ese par produce un torque que intenta alinear mu con B.'],
               'despejes': ['mu = tau/(Bsin(theta))',
                            'B = tau/(mu sin(theta))',
                            'I = tau/(NABsin(theta))',
                            'A = tau/(NIBsin(theta))'],
               'formulas_relacionadas': ['mu=NIA', 'F=IL×B', 'U=-mu·B'],
               'uso': 'Resolver espiras, bobinas y motores en campos magnéticos.',
               'cuando_usarla': ['Cuando una espira con corriente está en un campo B.',
                                 'Cuando piden torque máximo.',
                                 'Cuando se menciona rotación de una bobina.'],
               'procedimiento': ['Calcula mu=NIA.',
                                 'Identifica el ángulo entre mu y B.',
                                 'Usa tau=muBsin(theta).',
                                 'Dirección con regla de la mano derecha para producto vectorial.'],
               'detalles': ['Torque máximo si mu es perpendicular a B.',
                            'Torque cero si mu es paralelo o antiparalelo a B.',
                            'Este principio aparece en motores eléctricos.'],
               'errores_tipicos': ['Usar ángulo entre el plano de la espira y B en vez de entre mu y B.',
                                   'Olvidar que mu es normal al plano.',
                                   'Confundir torque con fuerza neta.'],
               'latex_base': '$\\vec\\tau=\\vec\\mu\\times\\vec B$',
               'latex_principal': '$\\tau=\\mu B\\sin\\theta=NIA B\\sin\\theta$',
               'latex_despejes': ['$I=\\frac{\\tau}{NAB\\sin\\theta}$', '$B=\\frac{\\tau}{\\mu\\sin\\theta}$']},
              {'nombre': 'Energía de un dipolo magnético',
               ...
               'sale_de': ['El campo magnético ejerce un torque que tiende a alinear mu con B.',
                           'La energía potencial es mínima cuando mu y B están alineados.',
                           'La forma escalar que cumple esto es U=-muBcos(theta).'],
               'despejes': ['mu = -U/(Bcos(theta))', 'B = -U/(mu cos(theta))', 'cos(theta) = -U/(muB)'],
               'formulas_relacionadas': ['tau=mu×B', 'mu=NIA', 'Trabajo asociado a rotación'],
               'uso': 'Problemas de orientación de espiras o dipolos magnéticos.',
               'cuando_usarla': ['Cuando se habla de energía potencial de una espira.',
                                 'Cuando piden configuración estable.',
                                 'Cuando se compara orientación paralela y antiparalela.'],
               'procedimiento': ['Calcula mu.',
                                 'Identifica theta entre mu y B.',
                                 'Usa U=-muBcos(theta).',
                                 'Compara energías si hay varias orientaciones.'],
               'detalles': ['Mínimo de energía: mu paralelo a B.', 'Máximo de energía: mu antiparalelo a B.'],
               'errores_tipicos': ['Usar seno en energía en vez de coseno.',
                                   'Confundir el ángulo del plano de la espira con el de mu.',
                                   'Olvidar el signo menos.'],
               'latex_base': '$U=-\\vec\\mu\\cdot\\vec B$',
               'latex_principal': '$U=-\\mu B\\cos\\theta$',
               'latex_despejes': ['$\\cos\\theta=-\\frac{U}{\\mu B}$', '$\\mu=-\\frac{U}{B\\cos\\theta}$']}],
 'interpretacion_enunciados': [{'palabra_clave': 'carga moviéndose en un campo B',
                                ...
                                'operaciones_recomendadas': ['Identifica q, v y B.',
                               ...
                               {'palabra_clave': 'trayectoria circular / radio de giro',
                                ...
                                'que_suele_pedir': ['Radio de la trayectoria.',
                                                    'Velocidad de la partícula.',
                                                    'Masa o carga.',
                                                    'Campo magnético necesario.',
                                                    'Periodo o frecuencia.'],
                                'operaciones_recomendadas': ['Comprueba si v es perpendicular a B.',
                                                             'Iguala |q|vB=mv²/r.',
                                                             'Usa r=mv/(|q|B).',
                               ...
                               {'palabra_clave': 'conductor con corriente dentro de B',
                                ...
                                'que_suele_pedir': ['Fuerza sobre un tramo recto.',
                                                    'Dirección de la fuerza.',
                                                    'Corriente o longitud necesaria.',
                                                    'Equilibrio de un conductor.'],
                                'operaciones_recomendadas': ['Identifica dirección de la corriente.',
                                                             'Usa F=ILBsin(theta).',
                               ...
                               {'palabra_clave': 'hilo recto largo',
                                ...
                                'que_suele_pedir': ['Campo B a distancia r.',
                                                    'Dirección del campo.',
                                                    'Fuerza sobre otra corriente cercana.',
                                                    'Superposición de campos de varios hilos.'],
                                'operaciones_recomendadas': ['Usa B=μ0I/(2πr).',
                               ...
                               {'palabra_clave': 'dos hilos paralelos',
                                ...
                                'que_suele_pedir': ['Atracción o repulsión.',
                                                    'Fuerza por unidad de longitud.',
                                                    'Distancia entre hilos.',
                                                    'Corriente desconocida.'],
                                'operaciones_recomendadas': ['Usa F/L=μ0I1I2/(2πd).',
                                                             'Mismo sentido de corriente: atracción.',
                                                             'Sentidos opuestos: repulsión.',
                               ...
                               {'palabra_clave': 'Biot-Savart / elemento de corriente',
                                ...
                                'que_suele_pedir': ['Campo de un arco.',
                                                    'Campo de una espira.',
                                                    'Campo de un segmento finito.',
                                                    'Dirección de dB.'],
                                'operaciones_recomendadas': ['Escribe dB=(μ0/4π)I(dl×r_hat)/r².',
                               ...
                               {'palabra_clave': 'toroide',
                                ...
                                'que_suele_pedir': ['Campo dentro del toroide.',
                                                    'Campo fuera idealmente.',
                                                    'Dependencia con r.',
                                                    'Corriente o número de vueltas.'],
                                'operaciones_recomendadas': ['Usa B=μ0NI/(2πr) dentro.',
                               ...
                               {'palabra_clave': 'espira en un campo magnético / torque',
                                ...
                                'que_suele_pedir': ['Torque sobre la espira.',
                                                    'Momento magnético.',
                                                    'Orientación estable.',
                                                    'Energía potencial.'],
                                'operaciones_recomendadas': ['Calcula μ=NIA.',
                                                             'Determina dirección de μ con regla de la mano derecha.',
                                                             'Usa τ=μBsin(theta).',
                                                             'Si piden energía, usa U=-μBcos(theta).'],
                                'pista_examen': 'El ángulo es entre μ y B, no necesariamente entre el plano de la '
                                                'espira y B.'}],
 'flashcards': [{'id': 'fis2_fc_001',
                 'frente': '¿Fórmula vectorial de fuerza magnética sobre una carga?',
                 'reverso': 'F = q v × B.',
                 'categoria': 'Fuerza magnética'},
                {'id': 'fis2_fc_002',
                 'frente': '¿Módulo de fuerza magnética sobre una carga?',
                 'reverso': '|F|=|q|vBsin(theta).',
                 'categoria': 'Fuerza magnética'},
                {'id': 'fis2_fc_003',
                 'frente': '¿Cuándo es cero la fuerza magnética sobre una carga?',
                 'reverso': 'Si v es paralela/antiparalela a B, si v=0 o si q=0.',
                 'categoria': 'Fuerza magnética'},
                {'id': 'fis2_fc_004',
                 'frente': '¿Qué haces si la carga es negativa al usar regla de la mano derecha?',
                 'reverso': 'Inviertes el sentido obtenido para v×B.',
                 'categoria': 'Fuerza magnética'},
                {'id': 'fis2_fc_005',
                 'frente': '¿La fuerza magnética realiza trabajo?',
                 'reverso': 'No, porque es perpendicular a la velocidad.',
                 'categoria': 'Fuerza magnética'},
                {'id': 'fis2_fc_006',
                 'frente': '¿Radio de giro de una carga en B perpendicular?',
                 'reverso': 'r=mv/(|q|B).',
                 'categoria': 'Movimiento circular'},
                {'id': 'fis2_fc_007',
                 'frente': '¿Frecuencia angular ciclotrón?',
                 'reverso': 'omega=|q|B/m.',
                 'categoria': 'Movimiento circular'},
                {'id': 'fis2_fc_008',
                 'frente': '¿Fuerza sobre conductor con corriente?',
                 'reverso': 'F=IL×B.',
                 'categoria': 'Conductor'},
                {'id': 'fis2_fc_009',
                 'frente': '¿Módulo de fuerza sobre conductor recto?',
                 'reverso': 'F=ILBsin(theta).',
                 'categoria': 'Conductor'},
                {'id': 'fis2_fc_010',
                 'frente': '¿Campo alrededor de un hilo recto largo?',
                 'reverso': 'B=μ0I/(2πr).',
                 'categoria': 'Hilo recto'},
                {'id': 'fis2_fc_011',
                 'frente': '¿Forma de las líneas de B alrededor de un hilo recto?',
                 'reverso': 'Circunferencias alrededor del hilo.',
                 'categoria': 'Hilo recto'},
                {'id': 'fis2_fc_012',
                 'frente': '¿Cómo determinas el sentido de B alrededor de un hilo?',
                 'reverso': 'Regla de la mano derecha: pulgar corriente, dedos B.',
                 'categoria': 'Hilo recto'},
                {'id': 'fis2_fc_013',
                 'frente': '¿Qué pasa con dos hilos con corriente en el mismo sentido?',
                 'reverso': 'Se atraen.',
                 'categoria': 'Hilos paralelos'},
                {'id': 'fis2_fc_014',
                 'frente': '¿Qué pasa con dos hilos con corrientes opuestas?',
                 'reverso': 'Se repelen.',
                 'categoria': 'Hilos paralelos'},
                {'id': 'fis2_fc_015',
                 'frente': '¿Fuerza por longitud entre hilos paralelos?',
                 'reverso': 'F/L=μ0I1I2/(2πd).',
                 'categoria': 'Hilos paralelos'},
                {'id': 'fis2_fc_016',
                 'frente': '¿Flujo magnético en campo uniforme?',
                 'reverso': 'Phi_B=BAcos(theta).',
                 'categoria': 'Flujo magnético'},
                {'id': 'fis2_fc_017',
                 'frente': 'En flujo magnético, ¿theta es con la superficie o la normal?',
                 'reverso': 'Con la normal.',
                 'categoria': 'Flujo magnético'},
                {'id': 'fis2_fc_018',
                 'frente': '¿Ley de Biot-Savart?',
                 'reverso': 'dB=(μ0/4π)I(dl×r_hat)/r².',
                 'categoria': 'Biot-Savart'},
                {'id': 'fis2_fc_019',
                 'frente': '¿Campo en el centro de una espira circular?',
                 'reverso': 'B=μ0I/(2R).',
                 'categoria': 'Espira'},
                {'id': 'fis2_fc_020',
                 'frente': '¿Campo en el centro de N espiras?',
                 'reverso': 'B=μ0NI/(2R).',
                 'categoria': 'Espira'},
                {'id': 'fis2_fc_021', 'frente': '¿Ley de Ampère?', 'reverso': '∮B·dl=μ0I_enc.', 'categoria': 'Ampère'},
                {'id': 'fis2_fc_022',
                 'frente': '¿Cuándo conviene usar Ampère?',
                 'reverso': 'Con simetría: hilo largo, solenoide, toroide.',
                 'categoria': 'Ampère'},
                {'id': 'fis2_fc_023',
                 'frente': '¿Campo dentro de un solenoide ideal?',
                 'reverso': 'B=μ0nI.',
                 'categoria': 'Solenoide'},
                {'id': 'fis2_fc_024',
                 'frente': '¿Qué es n en un solenoide?',
                 'reverso': 'Número de espiras por unidad de longitud: n=N/L.',
                 'categoria': 'Solenoide'},
                {'id': 'fis2_fc_025',
                 'frente': '¿Campo dentro de un toroide?',
                 'reverso': 'B=μ0NI/(2πr).',
                 'categoria': 'Toroide'},
                {'id': 'fis2_fc_026',
                 'frente': '¿Momento magnético de una espira?',
                 'reverso': 'μ=NIA.',
                 'categoria': 'Dipolo magnético'},
                {'id': 'fis2_fc_027',
                 'frente': '¿Torque sobre una espira?',
                 'reverso': 'τ=μ×B, módulo τ=μBsin(theta).',
                 'categoria': 'Torque'},
                {'id': 'fis2_fc_028',
                 'frente': '¿Energía de un dipolo magnético?',
                 'reverso': 'U=-μ·B=-μBcos(theta).',
                 'categoria': 'Dipolo magnético'},
                {'id': 'fis2_fc_029',
                 'frente': '¿Valor de μ0?',
                 'reverso': 'μ0=4π×10^-7 T·m/A.',
                 'categoria': 'Constantes'},
                {'id': 'fis2_fc_030',
                 'frente': '¿Qué significa una × en diagramas de B?',
                 'reverso': 'Campo entrando en la pantalla.',
                 'categoria': 'Dirección'},
                {'id': 'fis2_fc_031',
                 'frente': '¿Qué significa un punto • en diagramas de B?',
                 'reverso': 'Campo saliendo de la pantalla.',
                 'categoria': 'Dirección'},
                {'id': 'fis2_fc_032',
                 'frente': '¿Qué trayectoria amperiana usas para un hilo largo?',
                 'reverso': 'Una circunferencia centrada en el hilo.',
                 'categoria': 'Ampère'},
                {'id': 'fis2_fc_033',
                 'frente': '¿Qué trayectoria amperiana usas para un toroide?',
                 'reverso': 'Una circunferencia dentro del toroide.',
                 'categoria': 'Ampère'},
                {'id': 'fis2_fc_034',
                 'frente': '¿Qué ley usarías para un arco circular de corriente?',
                 'reverso': 'Biot-Savart.',
                 'categoria': 'Biot-Savart'},
                {'id': 'fis2_fc_035',
                 'frente': '¿Campo de un arco circular de ángulo phi en el centro?',
                 'reverso': 'B=μ0Iphi/(4πR), con phi en radianes.',
                 'categoria': 'Biot-Savart'}],
 'preguntas_vf': [{'id': 'fis2_vf_001',
                   'pregunta': 'Una carga en reposo en un campo magnético uniforme siente fuerza magnética.',
                   'respuesta': False,
                   'explicacion': 'La fuerza magnética sobre una carga es qv×B; si v=0, F=0.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_002',
                   'pregunta': 'Si v es paralela a B, la fuerza magnética es máxima.',
                   'respuesta': False,
                   'explicacion': 'Si v es paralela a B, sin(theta)=0 y F=0.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_003',
                   'pregunta': 'Si v es perpendicular a B, la fuerza magnética tiene módulo |q|vB.',
                   'respuesta': True,
                   'explicacion': 'Para theta=90°, sin(theta)=1.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_004',
                   'pregunta': 'La fuerza magnética es perpendicular a la velocidad.',
                   'respuesta': True,
                   'explicacion': 'F=qv×B, producto vectorial perpendicular a v y B.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_005',
                   'pregunta': 'Para una carga negativa se invierte la dirección obtenida con v×B.',
                   'respuesta': True,
                   'explicacion': 'El factor q negativo cambia el sentido de la fuerza.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_006',
                   'pregunta': 'La fuerza magnética realiza trabajo sobre una carga y aumenta su rapidez.',
                   'respuesta': False,
                   'explicacion': 'La fuerza magnética es perpendicular a v, por eso no realiza trabajo.',
                   'categoria': 'Fuerza magnética',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_007',
                   'pregunta': 'Una carga que entra perpendicularmente a B puede describir una trayectoria circular.',
                   'respuesta': True,
                   'explicacion': 'La fuerza magnética actúa como fuerza centrípeta.',
                   'categoria': 'Movimiento circular',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_008',
                   'pregunta': 'El radio de giro magnético es r=mv/(|q|B).',
                   'respuesta': True,
                   'explicacion': 'Sale de igualar |q|vB=mv²/r.',
                   'categoria': 'Movimiento circular',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_009',
                   'pregunta': 'Si aumenta B, el radio de la trayectoria aumenta.',
                   'respuesta': False,
                   'explicacion': 'r=mv/(|q|B), así que si B aumenta, r disminuye.',
                   'categoria': 'Movimiento circular',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_010',
                   'pregunta': 'La fuerza sobre un conductor con corriente es F=IL×B.',
                   'respuesta': True,
                   'explicacion': 'Es la forma vectorial para un tramo recto de conductor.',
                   'categoria': 'Conductor',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_011',
                   'pregunta': 'Si un conductor con corriente es paralelo a B, la fuerza magnética sobre él es cero.',
                   'respuesta': True,
                   'explicacion': 'El ángulo es 0 y sin(theta)=0.',
                   'categoria': 'Conductor',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_012',
                   'pregunta': 'El campo magnético alrededor de un hilo recto largo apunta radialmente hacia afuera.',
                   'respuesta': False,
                   'explicacion': 'Las líneas de B son circunferencias alrededor del hilo.',
                   'categoria': 'Hilo recto',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_013',
                   'pregunta': 'Para un hilo recto largo, B=μ0I/(2πr).',
                   'respuesta': True,
                   'explicacion': 'Es el resultado estándar por Ampère o Biot-Savart.',
                   'categoria': 'Hilo recto',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_014',
                   'pregunta': 'Dos hilos paralelos con corrientes en el mismo sentido se atraen.',
                   'respuesta': True,
                   'explicacion': 'Es el resultado magnético entre corrientes paralelas.',
                   'categoria': 'Hilos paralelos',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_015',
                   'pregunta': 'Dos hilos paralelos con corrientes opuestas se atraen.',
                   'respuesta': False,
                   'explicacion': 'Corrientes opuestas se repelen.',
                   'categoria': 'Hilos paralelos',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_016',
                   'pregunta': 'El flujo magnético se calcula con el ángulo entre B y la superficie.',
                   'respuesta': False,
                   'explicacion': 'Se usa el ángulo entre B y la normal de la superficie.',
                   'categoria': 'Flujo magnético',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_017',
                   'pregunta': 'Si B es paralelo a una superficie, el flujo magnético a través de ella es cero.',
                   'respuesta': True,
                   'explicacion': 'B no atraviesa la superficie; el ángulo con la normal es 90°.',
                   'categoria': 'Flujo magnético',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_018',
                   'pregunta': 'La Ley de Biot-Savart usa un producto vectorial dl×r_hat.',
                   'respuesta': True,
                   'explicacion': 'La dirección de dB viene de ese producto vectorial.',
                   'categoria': 'Biot-Savart',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_019',
                   'pregunta': 'Biot-Savart siempre evita integrar.',
                   'respuesta': False,
                   'explicacion': 'Biot-Savart normalmente requiere integrar contribuciones dB.',
                   'categoria': 'Biot-Savart',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_020',
                   'pregunta': 'El campo en el centro de una espira circular es B=μ0I/(2R).',
                   'respuesta': True,
                   'explicacion': 'Es el resultado estándar para una espira de radio R.',
                   'categoria': 'Espira',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_021',
                   'pregunta': 'Para N espiras iguales, el campo en el centro se multiplica por N.',
                   'respuesta': True,
                   'explicacion': 'Cada espira aporta el mismo campo en el centro.',
                   'categoria': 'Espira',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_022',
                   'pregunta': 'La Ley de Ampère es ∮B·dl=μ0I_enc.',
                   'respuesta': True,
                   'explicacion': 'Es la forma magnetostática de Ampère.',
                   'categoria': 'Ampère',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_023',
                   'pregunta': 'Ampère siempre permite calcular B fácilmente aunque no haya simetría.',
                   'respuesta': False,
                   'explicacion': 'La ley es válida, pero solo simplifica con simetría.',
                   'categoria': 'Ampère',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_024',
                   'pregunta': 'En un solenoide ideal largo, B=μ0nI.',
                   'respuesta': True,
                   'explicacion': 'n es el número de espiras por unidad de longitud.',
                   'categoria': 'Solenoide',
                   'dificultad': 'facil'},
                  {'id': 'fis2_vf_025',
                   'pregunta': 'En un solenoide, n significa número total de espiras.',
                   'respuesta': False,
                   'explicacion': 'n=N/L, espiras por unidad de longitud.',
                   'categoria': 'Solenoide',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_026',
                   'pregunta': 'En un toroide ideal, el campo dentro puede escribirse B=μ0NI/(2πr).',
                   'respuesta': True,
                   'explicacion': 'Sale de Ampère con trayectoria circular interna.',
                   'categoria': 'Toroide',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_027',
                   'pregunta': 'El momento magnético de una espira es paralelo al plano de la espira.',
                   'respuesta': False,
                   'explicacion': 'El momento magnético es perpendicular al plano de la espira.',
                   'categoria': 'Dipolo magnético',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_028',
                   'pregunta': 'El torque sobre una espira es máximo cuando μ es perpendicular a B.',
                   'respuesta': True,
                   'explicacion': 'τ=μBsin(theta), máximo para theta=90°.',
                   'categoria': 'Torque',
                   'dificultad': 'media'},
                  {'id': 'fis2_vf_029',
                   'pregunta': 'La energía U=-μBcos(theta) es mínima cuando μ y B están alineados.',
                   'respuesta': True,
                   'explicacion': 'Si theta=0, U=-μB, el valor mínimo.',
                   'categoria': 'Dipolo magnético',
                   'dificultad': 'dificil'},
                  {'id': 'fis2_vf_030',
                   'pregunta': 'En un dibujo, una cruz × suele indicar campo entrando en la pantalla.',
                   'respuesta': True,
                   'explicacion': 'Se usa como la cola de una flecha que se aleja de ti.',
                   'categoria': 'Dirección',
                   'dificultad': 'facil'}],
 'preguntas_mc': [{'id': 'fis2_mc_001',
