...
TEMA3 = {'nombre': 'Tema 3 - Corriente, circuitos, capacitores e inducción',
 'resumen': '\n'
 ...
 'formulas': [{'nombre': 'Corriente eléctrica',
               ...
               'sale_de': ['La corriente se define como tasa de flujo de carga.',
                           'Si la carga pasa de forma aproximadamente constante, se usa I=Δq/Δt.',
                           'Si cambia instantáneamente, se usa la derivada I=dq/dt.'],
               'despejes': ['Δq = I Δt', 'Δt = Δq/I', 'q(t) = ∫ I(t) dt'],
               'formulas_relacionadas': ['J=I/A', 'I=nqAv_d', 'P=IV', 'V=IR'],
               'uso': 'Calcular corriente, carga transferida o tiempo.',
               'cuando_usarla': ['Cuando el enunciado habla de carga que atraviesa una sección.',
                                 'Cuando dan tiempo y carga.',
                                 'Cuando piden cuántos electrones pasan por segundo.'],
               'procedimiento': ['Convierte carga a C y tiempo a s.',
                                 'Usa I=Δq/Δt.',
                                 'Si preguntan número de electrones, divide carga total entre e.'],
               'errores_tipicos': ['No convertir mA a A.',
                                   'Confundir corriente convencional con movimiento de electrones.',
                                   'Olvidar que 1 A = 1 C/s.'],
               'latex_base': '$I=\\frac{\\Delta q}{\\Delta t}$',
               'latex_principal': '$I=\\frac{dq}{dt}$',
               'latex_despejes': ['$\\Delta q=I\\Delta t$', '$q(t)=\\int I(t)\\,dt$']},
              {'nombre': 'Densidad de corriente',
               'idea_clave': 'La densidad de corriente mide corriente por área.',
               'formula_base': 'J = I/A',
               'formula_principal': 'I = J A',
               'sale_de': ['Si una corriente I se reparte uniformemente por un área A, la corriente por unidad de área '
                           'es J.',
                           'Por tanto J=I/A.',
                           'Si J no es uniforme, la corriente se obtiene integrando J·dA.'],
               'despejes': ['I = J A', 'A = I/J'],
               'formulas_relacionadas': ['J = nqv_d', 'J = sigma E', 'E = rho J'],
               'uso': 'Relacionar corriente con área transversal de un conductor.',
               'cuando_usarla': ['Cuando aparece área de un cable.',
                                 'Cuando te piden densidad de corriente.',
                                 'Cuando se conecta con resistividad o velocidad de deriva.'],
               'procedimiento': ['Calcula el área transversal.', 'Usa J=I/A.', 'Mantén unidades en m².'],
               'errores_tipicos': ['Usar diámetro en vez de área.',
                                   'No convertir mm² o cm² a m².',
                                   'Olvidar que J es vector en general.'],
               'latex_base': '$J=\\frac{I}{A}$',
               'latex_principal': '$I=JA$',
               'latex_despejes': ['$A=\\frac{I}{J}$']},
              ...
              {'nombre': 'Ley de Ohm microscópica',
               ...
               'sale_de': ['En materiales óhmicos, la densidad de corriente es proporcional al campo aplicado.',
                           'La constante de proporcionalidad es la conductividad sigma.',
                           'La resistividad es rho=1/sigma, por eso E=rho J.'],
               'despejes': ['sigma = J/E', 'E = J/sigma', 'rho = E/J', 'J = E/rho'],
               'formulas_relacionadas': ['R=rho L/A', 'V=IR', 'J=I/A', 'E=V/L'],
               'uso': 'Conectar la física microscópica del material con la resistencia macroscópica.',
               'cuando_usarla': ['Cuando aparecen conductividad o resistividad.',
                                 'Cuando se habla de campo eléctrico dentro de un conductor.',
                                 'Cuando se deriva R=rho L/A.'],
               'procedimiento': ['Identifica si te dan sigma o rho.',
                                 'Usa J=sigma E o E=rho J.',
                                 'Conecta con I/A y V/L si hay geometría.'],
               'errores_tipicos': ['Confundir conductividad sigma con densidad superficial de carga.',
                                   'Confundir rho resistividad con densidad de carga.',
                                   'Usar V=IR sin revisar si el problema pide forma microscópica.'],
               'latex_base': '$\\vec J=\\sigma\\vec E$',
               'latex_principal': '$\\vec E=\\rho\\vec J$',
               'latex_despejes': ['$\\sigma=\\frac{J}{E}$', '$\\rho=\\frac{E}{J}$']},
              {'nombre': 'Resistencia de un conductor',
               ...
               'sale_de': ['De la ley microscópica E=rho J.',
                           'Para conductor uniforme, E=V/L y J=I/A.',
                           'Sustituyendo: V/L=rho I/A.',
                           'Entonces V=I(rho L/A), y comparando con V=IR: R=rho L/A.'],
               'despejes': ['rho = RA/L', 'L = RA/rho', 'A = rho L/R'],
               'formulas_relacionadas': ['V=IR', 'J=I/A', 'E=V/L', 'rho(T)=rho_0[1+alpha(T-T_0)]'],
               'uso': 'Calcular resistencia de cables o conductores uniformes.',
               'cuando_usarla': ['Cuando dan longitud, área y resistividad.',
                                 'Cuando comparas cables de distinto grosor.',
                                 'Cuando te piden efecto de cambiar L o A.'],
               'procedimiento': ['Convierte L a m y A a m².',
                                 'Usa R=rho L/A.',
                                 'Si el área viene por radio, calcula A=πr².'],
               'errores_tipicos': ['Usar diámetro como radio.',
                                   'No convertir mm² a m².',
                                   'Pensar que aumentar área aumenta resistencia.'],
               'latex_base': '$R=\\rho\\frac{L}{A}$',
               'latex_principal': '$R=\\frac{\\rho L}{A}$',
               'latex_despejes': ['$\\rho=\\frac{RA}{L}$', '$A=\\frac{\\rho L}{R}$']},
              {'nombre': 'Dependencia de resistividad con temperatura',
               ...
               'sale_de': ['La resistividad del material cambia con temperatura.',
               ...
               'despejes': ['alpha = (R/R_0 - 1)/(T-T_0)', 'T = T_0 + (R/R_0 - 1)/alpha', 'R_0 = R/[1+alpha(T-T_0)]'],
               'formulas_relacionadas': ['R=rho L/A', 'V=IR', 'P=I²R'],
               'uso': 'Problemas donde cambia la temperatura de un conductor.',
               'cuando_usarla': ['Cuando aparece coeficiente de temperatura alpha.',
                                 'Cuando piden resistencia a otra temperatura.',
                                 'Cuando comparas resistencia caliente/fría.'],
               'procedimiento': ['Identifica T0 y T.', 'Calcula Delta T=T-T0.', 'Sustituye en R=R0[1+alpha Delta T].'],
               'errores_tipicos': ['Usar Celsius y Kelvin de forma inconsistente en diferencias; para Delta T son '
                                   'equivalentes.',
                                   'Olvidar que alpha puede ser negativo en algunos materiales.',
                                   'Aplicar la aproximación lineal fuera de rango sin cuidado.'],
               'latex_base': '$\\rho=\\rho_0[1+\\alpha(T-T_0)]$',
               'latex_principal': '$R=R_0[1+\\alpha(T-T_0)]$',
               'latex_despejes': ['$\\alpha=\\frac{R/R_0-1}{T-T_0}$', '$T=T_0+\\frac{R/R_0-1}{\\alpha}$']},
              {'nombre': 'Ley de Ohm macroscópica',
               ...
               'latex_base': '$V=IR$',
               'latex_principal': '$V=IR$',
               'latex_despejes': ['$I=\\frac{V}{R}$', '$R=\\frac{V}{I}$']},
              ...
              {'nombre': 'Resistencias en serie',
               ...
               'sale_de': ['En serie, la misma corriente I atraviesa cada resistencia.',
                           'El voltaje total es suma de caídas: V=V1+V2+...',
                           'Como V_i=IR_i, entonces V=I(R1+R2+...).',
                           'Comparando con V=IR_eq, se obtiene R_eq=R1+R2+...'],
               'despejes': ['R_n = R_eq - ΣR_otros', 'I = V_total/R_eq', 'V_i = I R_i'],
               'formulas_relacionadas': ['V=IR', 'P=I²R', 'Kirchhoff de mallas'],
               'uso': 'Reducir resistencias conectadas una detrás de otra.',
               'cuando_usarla': ['Cuando no hay nodos intermedios que dividan corriente.',
                                 'Cuando todos los elementos llevan la misma corriente.',
                                 'Cuando el circuito es una sola rama.'],
               'procedimiento': ['Identifica resistencias en una misma rama.',
                                 'Súmalas.',
                                 'Calcula corriente total si hay fuente.',
                                 'Calcula caídas de voltaje si se piden.'],
               'detalles': ['La resistencia equivalente es mayor que cada resistencia individual.',
                            'El voltaje se reparte proporcionalmente a R.'],
               'errores_tipicos': ['Pensar que el voltaje es igual en todas en serie.',
                                   'No reconocer una bifurcación.',
                                   'Sumar resistencias que en realidad están en paralelo.'],
               'latex_base': '$R_{\\mathrm{eq}}=R_1+R_2+\\cdots$',
               'latex_principal': '$R_{\\mathrm{eq}}=\\sum_i R_i$',
               'latex_despejes': ['$I=\\frac{V_{\\mathrm{total}}}{R_{\\mathrm{eq}}}$', '$V_i=IR_i$']},
              {'nombre': 'Resistencias en paralelo',
               ...
               'sale_de': ['En paralelo, cada rama tiene el mismo voltaje V.',
                           'La corriente total es I=I1+I2+...',
                           'Como I_i=V/R_i, entonces I=V(1/R1+1/R2+...).',
                           'Comparando con I=V/R_eq, se obtiene 1/R_eq=Σ1/R_i.'],
               'despejes': ['Para dos: R_eq = R1R2/(R1+R2)', 'I_total = V/R_eq', 'I_i = V/R_i', 'V = I_total R_eq'],
               'formulas_relacionadas': ['Kirchhoff de nodos', 'V=IR', 'P=V²/R'],
               'uso': 'Reducir resistencias conectadas entre los mismos dos nodos.',
               'cuando_usarla': ['Cuando las resistencias comparten los dos nodos.',
                                 'Cuando todas tienen el mismo voltaje.',
                                 'Cuando la corriente se divide en ramas.'],
               'procedimiento': ['Identifica los nodos comunes.',
                                 'Aplica inversos para obtener R_eq.',
                                 'Usa el mismo V en cada rama.',
                                 'Calcula corrientes de rama con I_i=V/R_i.'],
               'detalles': ['La R_eq en paralelo es menor que la menor resistencia.',
                            'La rama con menor R lleva mayor corriente.'],
               'errores_tipicos': ['Sumar directamente resistencias en paralelo.',
                                   'Pensar que la corriente es la misma en todas las ramas.',
                                   'Olvidar invertir al final.'],
               'latex_base': '$\\frac{1}{R_{\\mathrm{eq}}}=\\frac{1}{R_1}+\\frac{1}{R_2}+\\cdots$',
               'latex_principal': '$R_{\\mathrm{eq}}=\\frac{R_1R_2}{R_1+R_2}$',
               'latex_despejes': ['$I_i=\\frac{V}{R_i}$', '$I_{\\mathrm{total}}=\\sum_i I_i$']},
              {'nombre': 'Kirchhoff de nodos',
               ...
               'sale_de': ['La carga eléctrica se conserva.',
                           'En un nodo ideal no se acumula carga con el tiempo.',
                           'Por eso la corriente total que entra debe ser igual a la que sale.'],
               'despejes': ['I_desconocida = suma de corrientes opuestas según signos',
                            'Si I1 entra e I2,I3 salen: I1=I2+I3'],
               'formulas_relacionadas': ['I=Δq/Δt', 'Resistencias en paralelo', 'V=IR'],
               'uso': 'Resolver corrientes en circuitos con ramas.',
               'cuando_usarla': ['Cuando hay un nodo o unión.',
                                 'Cuando corrientes se dividen.',
                                 'Cuando no basta con serie/paralelo.'],
               'procedimiento': ['Elige signo para corrientes entrantes/salientes.',
                                 'Escribe la ecuación de conservación.',
                                 'Combina con Ohm si las corrientes dependen de voltajes.'],
               'errores_tipicos': ['No ser consistente con signos.',
                                   'Olvidar una rama.',
                                   'Pensar que una corriente desaparece en una resistencia.'],
               'latex_base': '$\\sum I_{\\mathrm{entrantes}}=\\sum I_{\\mathrm{salientes}}$',
               'latex_principal': '$\\sum I=0$',
               'latex_despejes': ['$I_1=I_2+I_3$']},
              {'nombre': 'Kirchhoff de mallas',
               ...
               'sale_de': ['La energía se conserva.',
                           'Al volver al punto de partida en una malla cerrada, el potencial final debe ser igual al '
                           'inicial.',
                           'Por eso la suma de subidas y caídas de potencial es cero.'],
               'despejes': ['I = Σepsilon/ΣR en una sola malla simple', 'epsilon = ΣIR', 'R_total = Σepsilon/I'],
               'formulas_relacionadas': ['V=IR', 'Potencia P=IV', 'Reglas de signos de baterías y resistencias'],
               'uso': 'Resolver circuitos con una o varias mallas.',
               'cuando_usarla': ['Cuando hay circuitos cerrados.',
                                 'Cuando hay varias baterías.',
                                 'Cuando no puedes reducir por serie/paralelo.',
                                 'Cuando piden ecuaciones de malla.'],
               'procedimiento': ['Elige sentido de recorrido.',
               ...
               'errores_tipicos': ['Cambiar signos sin consistencia.',
                                   'Olvidar que una corriente asumida negativa solo indica sentido contrario.',
                                   'No incluir todas las resistencias de la malla.'],
               'latex_base': '$\\sum\\Delta V=0$',
               'latex_principal': '$\\sum\\varepsilon-\\sum IR=0$',
               'latex_despejes': ['$I=\\frac{\\sum\\varepsilon}{\\sum R}$']},
              {'nombre': 'Capacitancia',
               'idea_clave': 'La capacitancia mide cuánta carga almacena un capacitor por voltaje aplicado.',
               'formula_base': 'C = Q/V',
               'formula_principal': 'Q = C V',
               'sale_de': ['Experimentalmente, en un capacitor ideal la carga almacenada es proporcional a la '
                           'diferencia de potencial.',
                           'La constante de proporcionalidad es C.',
                           'Por definición C=Q/V.'],
               'despejes': ['Q = C V', 'V = Q/C'],
               'formulas_relacionadas': ['U=1/2 QV', 'C=epsilon A/d', 'Capacitores en serie/paralelo'],
               'uso': 'Relacionar carga, voltaje y capacitancia.',
               'cuando_usarla': ['Cuando aparece un capacitor.',
                                 'Cuando piden carga almacenada.',
                                 'Cuando se da voltaje entre placas.'],
               'procedimiento': ['Convierte capacitancia a F.',
                                 'Usa Q=CV o V=Q/C.',
                                 'Cuida unidades como μF = 10^-6 F.'],
               'errores_tipicos': ['Confundir C de capacitancia con C de Coulomb.',
                                   'No convertir μF a F.',
                                   'Olvidar que Q en un capacitor representa magnitud de carga en cada placa.'],
               'latex_base': '$C=\\frac{Q}{V}$',
               'latex_principal': '$Q=CV$',
               'latex_despejes': ['$V=\\frac{Q}{C}$']},
              {'nombre': 'Capacitor de placas paralelas',
               ...
               'sale_de': ['Entre placas paralelas, el campo aproximado es E=sigma/epsilon.',
                           'La diferencia de potencial es V=Ed.',
                           'Como sigma=Q/A, entonces V=Qd/(epsilon A).',
                           'Usando C=Q/V, resulta C=epsilon A/d.'],
               'despejes': ['A = Cd/epsilon', 'd = epsilon A/C', 'epsilon = Cd/A', 'kappa = C/C0'],
               'formulas_relacionadas': ['C=Q/V', 'E=V/d', 'U=1/2 CV²', 'u=1/2 epsilon E²'],
               'uso': 'Calcular capacitancia de placas planas.',
               'cuando_usarla': ['Cuando hay dos placas paralelas.',
                                 'Cuando dan área, separación y dieléctrico.',
                                 'Cuando piden efecto de introducir un dieléctrico.'],
               'procedimiento': ['Convierte A y d a SI.',
                                 'Identifica epsilon=epsilon0 o kappa epsilon0.',
                                 'Usa C=epsilon A/d.'],
               'errores_tipicos': ['Usar cm² sin convertir a m².',
                                   'Confundir d con grosor de placa.',
                                   'Olvidar multiplicar por kappa si hay dieléctrico.'],
               'latex_base': '$C=\\varepsilon\\frac{A}{d}$',
               'latex_principal': '$C=\\kappa\\varepsilon_0\\frac{A}{d}$',
               'latex_despejes': ['$A=\\frac{Cd}{\\varepsilon}$', '$d=\\frac{\\varepsilon A}{C}$']},
              {'nombre': 'Capacitores en paralelo',
               ...
               'sale_de': ['En paralelo, cada capacitor tiene el mismo voltaje V.',
                           'La carga total es Q=Q1+Q2+...',
                           'Como Q_i=C_iV, entonces Q=V(C1+C2+...).',
                           'Comparando con Q=C_eqV, se obtiene C_eq=ΣC_i.'],
               'despejes': ['C_n = C_eq - ΣC_otros', 'Q_total = C_eq V', 'Q_i = C_i V'],
               'formulas_relacionadas': ['C=Q/V', 'Energía U=1/2CV²', 'Resistencias en serie/paralelo para comparar'],
               'uso': 'Reducir capacitores conectados entre los mismos dos nodos.',
               'cuando_usarla': ['Cuando los capacitores comparten voltaje.',
               ...
               'errores_tipicos': ['Aplicar la regla de resistencias en paralelo.',
                                   'Pensar que la carga es igual en todos.',
                                   'No identificar correctamente los nodos.'],
               'latex_base': '$C_{\\mathrm{eq}}=C_1+C_2+\\cdots$',
               'latex_principal': '$C_{\\mathrm{eq}}=\\sum_i C_i$',
               'latex_despejes': ['$Q_{\\mathrm{total}}=C_{\\mathrm{eq}}V$', '$Q_i=C_iV$']},
              {'nombre': 'Capacitores en serie',
               ...
               'sale_de': ['En serie, la misma magnitud de carga aparece en cada capacitor.',
                           'El voltaje total es V=V1+V2+...',
                           'Como V_i=Q/C_i, entonces V=Q(1/C1+1/C2+...).',
                           'Comparando con V=Q/C_eq, resulta 1/C_eq=Σ1/C_i.'],
               'despejes': ['Para dos: C_eq=C1C2/(C1+C2)', 'Q = C_eq V_total', 'V_i = Q/C_i'],
               'formulas_relacionadas': ['C=Q/V', 'Energía en capacitores', 'Kirchhoff de mallas'],
               'uso': 'Reducir capacitores conectados uno tras otro.',
               'cuando_usarla': ['Cuando la carga en cada capacitor es la misma.',
                                 'Cuando los voltajes se reparten.',
                                 'Cuando no hay ramificación entre capacitores.'],
               'procedimiento': ['Calcula C_eq con inversos.',
                                 'Calcula Q=C_eqV_total.',
                                 'Usa la misma Q para cada capacitor.',
                                 'Calcula V_i=Q/C_i.'],
               'errores_tipicos': ['Sumar capacitancias en serie directamente.',
                                   'Pensar que el voltaje es igual en todos.',
                                   'Olvidar invertir al final.'],
               'latex_base': '$\\frac{1}{C_{\\mathrm{eq}}}=\\frac{1}{C_1}+\\frac{1}{C_2}+\\cdots$',
               'latex_principal': '$C_{\\mathrm{eq}}=\\frac{C_1C_2}{C_1+C_2}$',
               'latex_despejes': ['$Q=C_{\\mathrm{eq}}V_{\\mathrm{total}}$', '$V_i=\\frac{Q}{C_i}$']},
              {'nombre': 'Energía almacenada en un capacitor',
               ...
               'sale_de': ['Al cargar un capacitor, el voltaje aumenta desde 0 hasta V.',
               ...
               'despejes': ['C = 2U/V²', 'V = sqrt(2U/C)', 'Q = sqrt(2CU)', 'Q = 2U/V'],
               'formulas_relacionadas': ['C=Q/V', 'C=epsilon A/d', 'u=1/2epsilon E²'],
               'uso': 'Calcular energía almacenada o liberada por capacitores.',
               'cuando_usarla': ['Cuando piden energía en un capacitor.',
                                 'Cuando comparas antes/después de conectar capacitores.',
                                 'Cuando aparece potencia o descarga.'],
               'procedimiento': ['Elige la forma según datos: Q,V,C.',
                                 'Sustituye unidades SI.',
                                 'Si hay varios capacitores, decide si piden energía total o individual.'],
               'errores_tipicos': ['Olvidar el factor 1/2.',
                                   'Usar C en microfaradios sin convertir.',
                                   'Confundir energía con carga.'],
               'latex_base': '$U=\\frac{1}{2}QV$',
               'latex_principal': '$U=\\frac{1}{2}CV^2=\\frac{Q^2}{2C}$',
               'latex_despejes': ['$C=\\frac{2U}{V^2}$', '$V=\\sqrt{\\frac{2U}{C}}$']},
              ...
              {'nombre': 'Circuito RC descargándose',
               ...
               'sale_de': ['Sin batería, Kirchhoff da iR + q/C = 0.',
                           'Como i=dq/dt con signo según convención, se obtiene dq/dt=-q/(RC).',
                           'La solución es q(t)=Q0e^{-t/RC}.'],
               'despejes': ['V_C(t)=V0e^{-t/RC}', 'i(t)=-(V0/R)e^{-t/RC}', 't = -RC ln(q/Q0)', 'tau=RC'],
               'formulas_relacionadas': ['C=Q/V', 'Energía U=1/2CV²', 'Potencia en resistencia P=i²R'],
               'uso': 'Resolver descarga temporal de capacitores.',
               'cuando_usarla': ['Cuando el capacitor ya está cargado y se conecta a una resistencia.',
                                 'Cuando no hay batería durante la descarga.',
                                 'Cuando aparece decaimiento exponencial.'],
               'procedimiento': ['Identifica Q0 o V0.',
                                 'Calcula tau=RC.',
                                 'Usa q(t)=Q0e^{-t/tau}.',
                                 'Si piden corriente, considera el signo según sentido elegido.'],
               'detalles': ['En t=tau queda aproximadamente 37% de la carga inicial.',
                            'Después de 5tau queda casi descargado.',
                            'La energía termina disipándose en la resistencia.'],
               'errores_tipicos': ['Usar 1-e^{-t/RC} en una descarga.',
                                   'Ignorar el sentido de la corriente.',
                                   'Pensar que se descarga completamente en un tiempo finito.'],
               'latex_base': '$\\tau=RC$',
               'latex_principal': '$q(t)=Q_0e^{-t/RC}$',
               'latex_despejes': ['$V_C(t)=V_0e^{-t/RC}$',
              ...
              {'nombre': 'Flujo magnético',
               ...
               'sale_de': ['El flujo cuenta la componente de B perpendicular al área.',
                           'El vector área apunta normal a la superficie.',
                           'Para B uniforme y área plana, Phi=BAcos(theta).'],
               'despejes': ['B = Phi_B/(Acos(theta))', 'A = Phi_B/(Bcos(theta))', 'theta = arccos(Phi_B/(BA))'],
               'formulas_relacionadas': ['Faraday: epsilon=-N dPhi_B/dt',
                                         'Lenz',
                                         'Phi_B=NBAcos(theta) si hay N espiras'],
               'uso': 'Calcular flujo a través de espiras o superficies.',
               'cuando_usarla': ['Cuando aparece campo magnético y área.',
                                 'Cuando hay bobinas/espiras.',
                                 'Cuando después se pide fem inducida.'],
               'procedimiento': ['Identifica la normal del área.',
                                 'Calcula el ángulo con B.',
                                 'Usa Phi=BAcos(theta).',
                                 'Si hay N espiras, el enlace de flujo es NPhi.'],
               'errores_tipicos': ['Usar el ángulo con la superficie en vez de la normal.',
                                   'Olvidar N en Faraday.',
                                   'Confundir flujo con campo.'],
               'latex_base': '$\\Phi_B=BA\\cos\\theta$',
               'latex_principal': '$\\Phi_B=\\int\\vec B\\cdot d\\vec A$',
               'latex_despejes': ['$B=\\frac{\\Phi_B}{A\\cos\\theta}$']},
              {'nombre': 'Ley de Faraday',
               ...
               'sale_de': ['Experimentalmente, una variación de flujo magnético a través de una espira induce '
                           'corriente.',
                           'La fem inducida es proporcional a la rapidez de cambio del flujo.',
                           'El signo negativo representa la Ley de Lenz.'],
               'despejes': ['ΔPhi_B = -epsilon Δt/N si epsilon es constante',
                            'N = |epsilon|/|dPhi_B/dt|',
                            'Si B cambia: epsilon = -N A cos(theta) dB/dt',
                            'Si A cambia: epsilon = -N B cos(theta) dA/dt'],
               'formulas_relacionadas': ['Phi_B=BAcos(theta)', 'Ley de Lenz', 'epsilon_L=-L dI/dt'],
               'uso': 'Calcular fem inducida por cambios de flujo magnético.',
               'cuando_usarla': ['Cuando cambia B, A o theta.',
               ...
               'procedimiento': ['Escribe Phi_B=BAcos(theta).',
                                 'Identifica qué variable cambia con el tiempo.',
                                 'Calcula dPhi/dt o ΔPhi/Δt.',
                                 'Multiplica por N.',
                                 'Usa Lenz para determinar el sentido.'],
               'errores_tipicos': ['Pensar que un flujo grande siempre induce fem; debe cambiar.',
                                   'Olvidar el signo conceptual de Lenz.',
                                   'No multiplicar por el número de espiras.',
                                   'Usar grados/radianes incorrectamente si theta cambia.'],
               'latex_base': '$\\varepsilon=-N\\frac{d\\Phi_B}{dt}$',
               'latex_principal': '$|\\varepsilon|=N\\left|\\frac{\\Delta\\Phi_B}{\\Delta t}\\right|$',
               'latex_despejes': ['$\\varepsilon=-NA\\cos\\theta\\frac{dB}{dt}$',
              ...
              {'nombre': 'Ley de Lenz',
               ...
               'sale_de': ['El signo menos en Faraday representa conservación de energía.',
               ...
               'errores_tipicos': ['Oponerse al campo en vez de oponerse al cambio de flujo.',
                                   'Confundir horario/antihorario al mirar desde lados distintos.',
                                   'Ignorar si el flujo aumenta o disminuye.'],
               'latex_base': '$\\varepsilon=-N\\frac{d\\Phi_B}{dt}$',
               'latex_principal': '$\\vec B_{\\mathrm{inducido}}\\ \\mathrm{se\\ opone\\ al\\ cambio\\ de}\\ \\Phi_B$',
               'latex_despejes': ['$\\Delta\\Phi_B>0\\Rightarrow \\mathrm{oposici\\acute{o}n\\ al\\ aumento}$',
                                  '$\\Delta\\Phi_B<0\\Rightarrow \\mathrm{oposici\\acute{o}n\\ a\\ la\\ '
                                  'disminuci\\acute{o}n}$']},
              {'nombre': 'Autoinducción',
               ...
               'sale_de': ['Una corriente en una bobina crea un campo magnético.',
               ...
               'despejes': ['L = -epsilon_L/(dI/dt)', 'dI/dt = -epsilon_L/L', 'epsilon_L ≈ -L ΔI/Δt'],
               'formulas_relacionadas': ['Faraday', 'Energía inductor U=1/2LI²', 'Circuito RL tau=L/R'],
               'uso': 'Problemas de bobinas e inductores con corriente variable.',
               'cuando_usarla': ['Cuando aparece un inductor L.',
                                 'Cuando la corriente cambia con el tiempo.',
                                 'Cuando se habla de fem autoinducida.'],
               'procedimiento': ['Identifica L y la rapidez de cambio de corriente.',
                                 'Usa epsilon_L=-L dI/dt.',
                                 'Interpreta el signo con Lenz.'],
               'errores_tipicos': ['Pensar que un inductor se opone a la corriente, no al cambio de corriente.',
                                   'Olvidar el signo de Lenz.',
                                   'Usar tau=RC para un circuito RL.'],
               'latex_base': '$\\varepsilon_L=-L\\frac{dI}{dt}$',
               'latex_principal': '$\\varepsilon_L=-L\\frac{dI}{dt}$',
               'latex_despejes': ['$L=-\\frac{\\varepsilon_L}{dI/dt}$']},
              {'nombre': 'Energía almacenada en un inductor',
               ...
               'sale_de': ['Para establecer corriente en un inductor, la fuente debe trabajar contra la fem '
                           'autoinducida.',
                           'Integrando la potencia asociada a la construcción de la corriente se obtiene U=1/2LI².'],
               'despejes': ['L = 2U/I²', 'I = sqrt(2U/L)'],
               'formulas_relacionadas': ['epsilon_L=-L dI/dt', 'Circuito RL', 'Energía capacitor U=1/2CV²'],
               'uso': 'Calcular energía en bobinas o inductores.',
               'cuando_usarla': ['Cuando aparece inductancia L y corriente I.',
                                 'Cuando piden energía magnética almacenada.',
                                 'Cuando comparas capacitor vs inductor.'],
               'procedimiento': ['Convierte L a henrios.', 'Usa U=1/2LI².', 'Si piden corriente, despeja I.'],
               'errores_tipicos': ['Usar voltaje en vez de corriente.',
                                   'Olvidar el factor 1/2.',
                                   'Confundir L de inductancia con longitud.'],
               'latex_base': '$U=\\frac{1}{2}LI^2$',
               'latex_principal': '$U=\\frac{1}{2}LI^2$',
               'latex_despejes': ['$I=\\sqrt{\\frac{2U}{L}}$', '$L=\\frac{2U}{I^2}$']},
              {'nombre': 'Circuito RL conectándose',
               ...
               'sale_de': ['Kirchhoff da V - IR - L dI/dt = 0.',
                           'La solución de esa ecuación diferencial con I(0)=0 es I(t)=(V/R)(1-e^{-tR/L}).',
                           'La constante de tiempo es tau=L/R.'],
               'despejes': ['I_final = V/R', 'tau = L/R', 't = -tau ln(1-I/I_final)'],
               'formulas_relacionadas': ['epsilon_L=-L dI/dt', 'V=IR', 'U=1/2LI²'],
               'uso': 'Resolver crecimiento de corriente en circuitos RL.',
               'cuando_usarla': ['Cuando hay resistencia e inductor con batería.',
                                 'Cuando la corriente está aumentando desde cero.',
                                 'Cuando aparece tau=L/R.'],
               'procedimiento': ['Calcula I_final=V/R.', 'Calcula tau=L/R.', 'Usa I(t)=I_final(1-e^{-t/tau}).'],
               'errores_tipicos': ['Usar tau=RC.',
                                   'Pensar que la corriente salta inmediatamente a V/R.',
                                   'Confundir el papel de capacitor e inductor.'],
               'latex_base': '$\\tau=\\frac{L}{R}$',
               'latex_principal': '$I(t)=\\frac{V}{R}\\left(1-e^{-tR/L}\\right)$',
               'latex_despejes': ['$I_{\\mathrm{final}}=\\frac{V}{R}$',
                                  '$t=-\\tau\\ln\\left(1-\\frac{I}{I_{\\mathrm{final}}}\\right)$']},
              {'nombre': 'Circuito RL desconectándose',
               ...
               'sale_de': ['Sin fuente, la ecuación de malla contiene la resistencia y la fem del inductor.',
                           'La solución indica que la corriente decae exponencialmente.',
                           'La escala temporal es tau=L/R.'],
               'despejes': ['t = -tau ln(I/I0)', 'tau=L/R', 'R=L/tau', 'L=Rtau'],
               'formulas_relacionadas': ['epsilon_L=-L dI/dt', 'U=1/2LI²', 'Potencia disipada P=I²R'],
               'uso': 'Corriente decreciente en circuitos RL.',
               'cuando_usarla': ['Cuando se desconecta la batería.',
                                 'Cuando una corriente inicial I0 decae.',
                                 'Cuando aparece inductor y resistencia.'],
               'procedimiento': ['Identifica I0.', 'Calcula tau=L/R.', 'Usa I(t)=I0e^{-t/tau}.'],
               'errores_tipicos': ['Usar fórmula de crecimiento para descarga.',
                                   'Usar RC en vez de L/R.',
                                   'Ignorar que el inductor intenta mantener la corriente.'],
               'latex_base': '$\\tau=\\frac{L}{R}$',
               'latex_principal': '$I(t)=I_0e^{-tR/L}$',
               'latex_despejes': ['$t=-\\tau\\ln\\left(\\frac{I}{I_0}\\right)$', '$L=R\\tau$']}],
 'interpretacion_enunciados': [{'palabra_clave': 'carga que pasa en un tiempo',
                                'que_significa': 'El problema pide corriente o carga transferida.',
                                'que_suele_pedir': ['Corriente media.',
                                                    'Carga total.',
                                                    'Número de electrones.',
                                                    'Tiempo necesario.'],
                                'operaciones_recomendadas': ['Usa I=Δq/Δt.',
                               ...
                               {'palabra_clave': 'longitud, área, resistividad',
                                ...
                                'que_suele_pedir': ['Resistencia de un cable.',
                                                    'Resistividad del material.',
                                                    'Efecto de cambiar longitud o grosor.'],
                                'operaciones_recomendadas': ['Usa R=rho L/A.',
                               ...
                               {'palabra_clave': 'voltaje, corriente y resistencia',
                                ...
                                'que_suele_pedir': ['Corriente.', 'Voltaje.', 'Resistencia.', 'Potencia.'],
                                'operaciones_recomendadas': ['Usa V=IR.',
                               ...
                               {'palabra_clave': 'potencia disipada',
                                ...
                                'que_suele_pedir': ['Potencia en una resistencia.',
                                                    'Energía consumida.',
                                                    'Calor disipado.',
                                                    'Coste eléctrico.'],
                                'operaciones_recomendadas': ['Usa P=IV.',
                               ...
                               {'palabra_clave': 'resistencias en serie',
                                ...
                                'que_suele_pedir': ['Resistencia equivalente.',
                                                    'Corriente total.',
                                                    'Caída de voltaje en cada resistencia.',
                                                    'Potencia en cada resistencia.'],
                                'operaciones_recomendadas': ['Suma resistencias.',
                                                             'Calcula I=V/R_eq.',
                                                             'Calcula V_i=IR_i.',
                               ...
                               {'palabra_clave': 'resistencias en paralelo',
                                ...
                                'que_suele_pedir': ['Resistencia equivalente.',
                                                    ...
                                                    'Corriente total.',
                                                    'Potencia por rama.'],
                                'operaciones_recomendadas': ['Usa 1/R_eq=Σ1/R_i.',
                                                             'Usa el mismo V en cada rama.',
                                                             'Calcula I_i=V/R_i.',
                                                             'Suma corrientes.'],
                               ...
                               {'palabra_clave': 'nodo / unión',
                                ...
                                'que_suele_pedir': ['Corriente desconocida.',
                                                    'Relación entre corrientes de ramas.',
                                                    'Sistema de ecuaciones.'],
                                'operaciones_recomendadas': ['Define qué corrientes entran y cuáles salen.',
                               ...
                               {'palabra_clave': 'malla / circuito cerrado',
                                ...
                                'que_suele_pedir': ['Corrientes de malla.',
                                                    'Voltajes en resistencias.',
                                                    'Ecuaciones de circuito.',
                                                    'Corriente con varias baterías.'],
                                'operaciones_recomendadas': ['Elige sentido de recorrido.',
                               ...
                               {'palabra_clave': 'capacitor / capacitancia',
                                ...
                                'que_suele_pedir': ['Carga en el capacitor.',
                                                    'Voltaje entre placas.',
                                                    'Capacitancia.',
                                                    'Energía almacenada.'],
                                'operaciones_recomendadas': ['Usa C=Q/V.',
                               ...
                               {'palabra_clave': 'capacitores en serie',
                                ...
                                'que_suele_pedir': ['Capacitancia equivalente.',
                                                    'Carga de cada capacitor.',
                                                    'Voltaje en cada capacitor.'],
                                'operaciones_recomendadas': ['Usa 1/C_eq=Σ1/C_i.',
                                                             'Calcula Q=C_eqV_total.',
                               ...
                               {'palabra_clave': 'capacitores en paralelo',
                                ...
                                'operaciones_recomendadas': ['Suma capacitancias.',
                                                             'Usa mismo V para cada capacitor.',
                                                             'Calcula Q_i=C_iV.',
                                                             'Suma cargas.'],
                               ...
                               {'palabra_clave': 'capacitor cargándose',
                                ...
                                'operaciones_recomendadas': ['Calcula tau=RC.',
                                                             'Usa q(t)=CV(1-e^{-t/RC}).',
                                                             'Usa i(t)=(V/R)e^{-t/RC}.',
                               ...
                               {'palabra_clave': 'capacitor descargándose',
                                ...
                                'que_suele_pedir': ['Carga restante.',
                                                    'Voltaje restante.',
                               ...
                               {'palabra_clave': 'flujo magnético cambiante',
                                ...
                                'que_suele_pedir': ['Fem inducida.',
                                                    'Corriente inducida.',
                                                    'Sentido horario/antihorario.',
                                                    'Cambio de flujo.'],
                                'operaciones_recomendadas': ['Escribe Phi_B=BAcos(theta).',
                               ...
                               {'palabra_clave': 'inductor / bobina con corriente variable',
                                ...
                                'que_suele_pedir': ['Fem autoinducida.',
                                                    'Corriente en función del tiempo.',
                                                    'Energía almacenada.',
                                                    'Constante de tiempo.'],
                                'operaciones_recomendadas': ['Usa epsilon_L=-L dI/dt.',
                                                             'Energía: U=1/2LI².',
                                                             'Para RL, tau=L/R.',
                                                             'Crecimiento: I=(V/R)(1-e^{-tR/L}).',
                                                             'Descarga: I=I0e^{-tR/L}.'],
                                'pista_examen': 'Inductor se opone a cambios de corriente; capacitor se opone a '
                                                'cambios de voltaje.'}],
 'flashcards': [{'id': 'fis3_fc_001',
                 'frente': '¿Definición de corriente?',
                 'reverso': 'I=Δq/Δt o I=dq/dt.',
                 'categoria': 'Corriente'},
                {'id': 'fis3_fc_002',
                 'frente': '¿Unidad de corriente?',
                 'reverso': 'Ampere, A = C/s.',
                 'categoria': 'Corriente'},
                {'id': 'fis3_fc_003',
                 'frente': '¿Densidad de corriente?',
                 'reverso': 'J=I/A.',
                 'categoria': 'Corriente'},
                {'id': 'fis3_fc_004',
                 'frente': '¿Corriente con velocidad de deriva?',
                 'reverso': 'I=nqAv_d.',
                 'categoria': 'Corriente'},
                {'id': 'fis3_fc_005',
                 'frente': '¿Ley de Ohm microscópica?',
                 'reverso': 'J=sigma E o E=rho J.',
                 'categoria': 'Ohm'},
                {'id': 'fis3_fc_006', 'frente': '¿Ley de Ohm macroscópica?', 'reverso': 'V=IR.', 'categoria': 'Ohm'},
                {'id': 'fis3_fc_007',
                 'frente': '¿Resistencia de un conductor?',
                 'reverso': 'R=rho L/A.',
                 'categoria': 'Resistencia'},
                {'id': 'fis3_fc_008',
                 'frente': 'Si aumenta el área del cable, ¿qué pasa con R?',
                 'reverso': 'Disminuye.',
                 'categoria': 'Resistencia'},
                {'id': 'fis3_fc_009',
                 'frente': 'Si aumenta la longitud del cable, ¿qué pasa con R?',
                 'reverso': 'Aumenta.',
                 'categoria': 'Resistencia'},
                {'id': 'fis3_fc_010',
                 'frente': '¿Potencia eléctrica base?',
                 'reverso': 'P=IV.',
                 'categoria': 'Potencia'},
                {'id': 'fis3_fc_011',
                 'frente': '¿Potencia en resistencia usando I y R?',
                 'reverso': 'P=I²R.',
                 'categoria': 'Potencia'},
                {'id': 'fis3_fc_012',
                 'frente': '¿Potencia en resistencia usando V y R?',
                 'reverso': 'P=V²/R.',
                 'categoria': 'Potencia'},
                {'id': 'fis3_fc_013',
                 'frente': 'En resistencias en serie, ¿qué es igual?',
                 'reverso': 'La corriente.',
                 'categoria': 'Serie'},
                {'id': 'fis3_fc_014',
                 'frente': 'Resistencias en serie equivalente:',
                 'reverso': 'R_eq=R1+R2+...',
                 'categoria': 'Serie'},
                {'id': 'fis3_fc_015',
                 'frente': 'En resistencias en paralelo, ¿qué es igual?',
                 'reverso': 'El voltaje.',
                 'categoria': 'Paralelo'},
                {'id': 'fis3_fc_016',
                 'frente': 'Resistencias en paralelo equivalente:',
                 'reverso': '1/R_eq=1/R1+1/R2+...',
                 'categoria': 'Paralelo'},
                {'id': 'fis3_fc_017',
                 'frente': '¿Ley de Kirchhoff de nodos?',
                 'reverso': 'ΣI_entrantes=ΣI_salientes.',
                 'categoria': 'Kirchhoff'},
                {'id': 'fis3_fc_018',
                 'frente': '¿Ley de Kirchhoff de mallas?',
                 'reverso': 'ΣΔV=0.',
                 'categoria': 'Kirchhoff'},
                {'id': 'fis3_fc_019',
                 'frente': '¿Definición de capacitancia?',
                 'reverso': 'C=Q/V.',
                 'categoria': 'Capacitores'},
                {'id': 'fis3_fc_020',
                 'frente': 'Capacitor de placas paralelas:',
                 'reverso': 'C=epsilon A/d.',
                 'categoria': 'Capacitores'},
                {'id': 'fis3_fc_021',
                 'frente': 'Capacitores en paralelo:',
                 'reverso': 'C_eq=C1+C2+...',
                 'categoria': 'Capacitores'},
                {'id': 'fis3_fc_022',
                 'frente': 'Capacitores en serie:',
                 'reverso': '1/C_eq=1/C1+1/C2+...',
                 'categoria': 'Capacitores'},
                {'id': 'fis3_fc_023',
                 'frente': 'Energía en capacitor:',
                 'reverso': 'U=1/2QV=1/2CV²=Q²/(2C).',
                 'categoria': 'Capacitores'},
                {'id': 'fis3_fc_024', 'frente': 'Constante de tiempo RC:', 'reverso': 'tau=RC.', 'categoria': 'RC'},
                {'id': 'fis3_fc_025',
                 'frente': 'Carga de capacitor en RC:',
                 'reverso': 'q(t)=CV(1-e^{-t/RC}).',
                 'categoria': 'RC'},
                {'id': 'fis3_fc_026',
                 'frente': 'Descarga de capacitor en RC:',
                 'reverso': 'q(t)=Q0e^{-t/RC}.',
                 'categoria': 'RC'},
                {'id': 'fis3_fc_027',
                 'frente': 'En t=tau durante carga RC, ¿qué porcentaje aproximado se alcanza?',
                 'reverso': 'Aproximadamente 63%.',
                 'categoria': 'RC'},
                {'id': 'fis3_fc_028',
                 'frente': 'En t=tau durante descarga RC, ¿qué porcentaje queda?',
                 'reverso': 'Aproximadamente 37%.',
                 'categoria': 'RC'},
                {'id': 'fis3_fc_029',
                 'frente': 'Flujo magnético:',
                 'reverso': 'Phi_B=BAcos(theta).',
                 'categoria': 'Faraday'},
                {'id': 'fis3_fc_030',
                 'frente': 'Ley de Faraday:',
                 'reverso': 'epsilon=-N dPhi_B/dt.',
                 'categoria': 'Faraday'},
                {'id': 'fis3_fc_031',
                 'frente': '¿Qué dice Lenz?',
                 'reverso': 'La corriente inducida se opone al cambio de flujo.',
                 'categoria': 'Lenz'},
                {'id': 'fis3_fc_032',
                 'frente': 'Autoinducción:',
                 'reverso': 'epsilon_L=-L dI/dt.',
                 'categoria': 'Inductores'},
                {'id': 'fis3_fc_033',
                 'frente': 'Energía en inductor:',
                 'reverso': 'U=1/2LI².',
                 'categoria': 'Inductores'},
                {'id': 'fis3_fc_034', 'frente': 'Constante de tiempo RL:', 'reverso': 'tau=L/R.', 'categoria': 'RL'},
                {'id': 'fis3_fc_035',
                 'frente': '¿Qué se opone a cambios bruscos de corriente?',
                 'reverso': 'El inductor.',
                 'categoria': 'Inductores'}],
 'preguntas_vf': [{'id': 'fis3_vf_001',
                   'pregunta': 'La corriente eléctrica es carga por unidad de tiempo.',
                   'respuesta': True,
                   'explicacion': 'I=Δq/Δt.',
                   'categoria': 'Corriente',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_002',
                   'pregunta': '1 ampere equivale a 1 coulomb por segundo.',
                   'respuesta': True,
                   'explicacion': '1 A=1 C/s.',
                   'categoria': 'Corriente',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_003',
                   'pregunta': 'La corriente convencional va en el mismo sentido que el movimiento de electrones en '
                               'metales.',
                   'respuesta': False,
                   'explicacion': 'Los electrones se mueven en sentido contrario a la corriente convencional.',
                   'categoria': 'Corriente',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_004',
                   'pregunta': 'La densidad de corriente es J=I/A.',
                   'respuesta': True,
                   'explicacion': 'Es corriente por área transversal.',
                   'categoria': 'Corriente',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_005',
                   'pregunta': 'Si aumenta el área de un cable, su resistencia aumenta.',
                   'respuesta': False,
                   'explicacion': 'R=rho L/A, al aumentar A disminuye R.',
                   'categoria': 'Resistencia',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_006',
                   'pregunta': 'Si aumenta la longitud de un cable, su resistencia aumenta.',
                   'respuesta': True,
                   'explicacion': 'R es proporcional a L.',
                   'categoria': 'Resistencia',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_007',
                   'pregunta': 'La ley de Ohm macroscópica es V=IR.',
                   'respuesta': True,
                   'explicacion': 'Para elementos óhmicos.',
                   'categoria': 'Ohm',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_008',
                   'pregunta': 'Todos los dispositivos cumplen la Ley de Ohm linealmente.',
                   'respuesta': False,
                   'explicacion': 'Muchos problemas lo asumen, pero no todos los dispositivos son óhmicos.',
                   'categoria': 'Ohm',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_009',
                   'pregunta': 'La potencia eléctrica puede calcularse como P=IV.',
                   'respuesta': True,
                   'explicacion': 'Es la relación base de potencia eléctrica.',
                   'categoria': 'Potencia',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_010',
                   'pregunta': 'En una resistencia, P=I²R.',
                   'respuesta': True,
                   'explicacion': 'Sale de P=IV y V=IR.',
                   'categoria': 'Potencia',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_011',
                   'pregunta': 'En resistencias en serie pasa la misma corriente por todas.',
                   'respuesta': True,
                   'explicacion': 'No hay ramificaciones.',
                   'categoria': 'Serie',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_012',
                   'pregunta': 'En resistencias en serie todas tienen el mismo voltaje.',
                   'respuesta': False,
                   'explicacion': 'En serie tienen la misma corriente; el voltaje se reparte.',
                   'categoria': 'Serie',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_013',
                   'pregunta': 'En resistencias en paralelo todas tienen el mismo voltaje.',
                   'respuesta': True,
                   'explicacion': 'Comparten los mismos dos nodos.',
                   'categoria': 'Paralelo',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_014',
                   'pregunta': 'En resistencias en paralelo todas tienen la misma corriente.',
                   'respuesta': False,
                   'explicacion': 'La corriente se divide según la resistencia de cada rama.',
                   'categoria': 'Paralelo',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_015',
                   'pregunta': 'La resistencia equivalente en paralelo es menor que la menor resistencia individual.',
                   'respuesta': True,
                   'explicacion': 'Esa es una propiedad importante del paralelo.',
                   'categoria': 'Paralelo',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_016',
                   'pregunta': 'Kirchhoff de nodos expresa conservación de carga.',
                   'respuesta': True,
                   'explicacion': 'La corriente que entra debe igualar la que sale.',
                   'categoria': 'Kirchhoff',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_017',
                   'pregunta': 'Kirchhoff de mallas expresa conservación de energía.',
                   'respuesta': True,
                   'explicacion': 'La suma de cambios de potencial en una malla cerrada es cero.',
                   'categoria': 'Kirchhoff',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_018',
                   'pregunta': 'La capacitancia se define como C=Q/V.',
                   'respuesta': True,
                   'explicacion': 'Carga almacenada por voltaje.',
                   'categoria': 'Capacitores',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_019',
                   'pregunta': 'En un capacitor de placas paralelas, aumentar la distancia aumenta la capacitancia.',
                   'respuesta': False,
                   'explicacion': 'C=epsilon A/d, al aumentar d disminuye C.',
                   'categoria': 'Capacitores',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_020',
                   'pregunta': 'Introducir un dieléctrico aumenta la capacitancia.',
                   'respuesta': True,
                   'explicacion': 'C=kappa C0 si kappa>1.',
                   'categoria': 'Capacitores',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_021',
                   'pregunta': 'Capacitores en paralelo se suman directamente.',
                   'respuesta': True,
                   'explicacion': 'C_eq=C1+C2+...',
                   'categoria': 'Capacitores',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_022',
                   'pregunta': 'Capacitores en serie tienen el mismo voltaje.',
                   'respuesta': False,
                   'explicacion': 'En serie tienen la misma carga; el voltaje se reparte.',
                   'categoria': 'Capacitores',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_023',
                   'pregunta': 'La energía de un capacitor es U=1/2CV².',
                   'respuesta': True,
                   'explicacion': 'También U=1/2QV=Q²/(2C).',
                   'categoria': 'Capacitores',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_024',
                   'pregunta': 'La constante de tiempo de un circuito RC es tau=RC.',
                   'respuesta': True,
                   'explicacion': 'tau=RC.',
                   'categoria': 'RC',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_025',
                   'pregunta': 'Durante la carga RC, q(t)=Q0e^{-t/RC}.',
                   'respuesta': False,
                   'explicacion': 'Esa es la forma de descarga; en carga q(t)=CV(1-e^{-t/RC}).',
                   'categoria': 'RC',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_026',
                   'pregunta': 'Durante la descarga RC, la carga decae exponencialmente.',
                   'respuesta': True,
                   'explicacion': 'q(t)=Q0e^{-t/RC}.',
                   'categoria': 'RC',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_027',
                   'pregunta': 'En t=tau, un capacitor cargándose alcanza aproximadamente 63% de la carga final.',
                   'respuesta': True,
                   'explicacion': '1-e^{-1}≈0.632.',
                   'categoria': 'RC',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_028',
                   'pregunta': 'La Ley de Faraday requiere cambio de flujo magnético.',
                   'respuesta': True,
                   'explicacion': 'epsilon=-N dPhi/dt.',
                   'categoria': 'Faraday',
                   'dificultad': 'facil'},
                  {'id': 'fis3_vf_029',
                   'pregunta': 'Si el flujo magnético es grande pero constante, hay fem inducida.',
                   'respuesta': False,
                   'explicacion': 'Debe cambiar el flujo; si dPhi/dt=0, epsilon=0.',
                   'categoria': 'Faraday',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_030',
                   'pregunta': 'La Ley de Lenz dice que la corriente inducida se opone al cambio de flujo.',
                   'respuesta': True,
                   'explicacion': 'No se opone necesariamente al campo, sino al cambio de flujo.',
                   'categoria': 'Lenz',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_031',
                   'pregunta': 'Un inductor se opone a cambios bruscos de corriente.',
                   'respuesta': True,
                   'explicacion': 'Por autoinducción epsilon_L=-L dI/dt.',
                   'categoria': 'Inductores',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_032',
                   'pregunta': 'La constante de tiempo de un circuito RL es tau=RC.',
                   'respuesta': False,
                   'explicacion': 'Para RL, tau=L/R.',
                   'categoria': 'RL',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_033',
                   'pregunta': 'La energía almacenada en un inductor es U=1/2LI².',
                   'respuesta': True,
                   'explicacion': 'Se almacena en el campo magnético.',
                   'categoria': 'Inductores',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_034',
                   'pregunta': 'Un capacitor ideal cargado se comporta como circuito abierto en DC a largo tiempo.',
                   'respuesta': True,
                   'explicacion': 'Cuando está cargado, no pasa corriente DC idealmente.',
                   'categoria': 'RC',
                   'dificultad': 'media'},
                  {'id': 'fis3_vf_035',
                   'pregunta': 'Un capacitor inicialmente descargado se comporta como circuito abierto justo al '
                               'conectarlo.',
                   'respuesta': False,
                   'explicacion': 'Justo al inicio se comporta como un cable ideal; después se va cargando.',
                   'categoria': 'RC',
                   'dificultad': 'dificil'}],
 'preguntas_mc': [{'id': 'fis3_mc_001',
                  ...
                  {'id': 'fis3_mc_008',
                   ...
                   'opciones': ['El voltaje es igual en todas',
                                'La corriente es igual en todas',
                                'La resistencia equivalente es menor que todas',
                  ...
                  {'id': 'fis3_mc_009',
                   ...
                   'opciones': ['La corriente es igual en todas',
                                'El voltaje es igual en todas',
                                'Las resistencias se suman directamente',
                  ...
                  {'id': 'fis3_mc_011',
                   ...
                   'opciones': ['Conservación de carga',
                                'Conservación de masa mecánica',
                                'Ley de Coulomb',
                                'Inducción magnética'],
                   'respuesta': 1,
                  ...
                  {'id': 'fis3_mc_015',
                   ...
                   'opciones': ['Se suman directamente',
                                'Usan inversos',
                                'Tienen la misma carga siempre',
                  ...
                  {'id': 'fis3_mc_016',
                   ...
                   'opciones': ['Se suman directamente',
                                'Usan inversos',
                                'Tienen el mismo voltaje siempre',
                                'No tienen carga'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis3_mc_023',
                   ...
                   'opciones': ['Se opone al cambio de flujo',
                                'Siempre aumenta el flujo',
                                'Siempre es horaria',
                  ...
                  {'id': 'fis3_mc_027',
                   ...
                   'opciones': ['Empieza máxima y decae',
                                'Empieza cero y aumenta para siempre',
                                'Es constante',
                                'No existe'],
                   'respuesta': 1,
                  ...
                  {'id': 'fis3_mc_028',
                   ...
                   'opciones': ['Se comporta como circuito abierto',
                                'Se comporta como resistencia cero',
                                'Desaparece',
                                'Tiene corriente infinita'],
                   'respuesta': 1,
                  ...
                  {'id': 'fis3_mc_029',
                   ...
                   'opciones': ['Se comporta inicialmente como cable ideal',
                                'Se comporta como circuito abierto inmediatamente',
                                'Tiene voltaje máximo',
                                'No circula corriente inicial'],
                   'respuesta': 1,
