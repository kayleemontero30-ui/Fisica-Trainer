...
TEMA1 = {'nombre': 'Tema 1 - Campo eléctrico y electrostática',
 'resumen': '\n'
 ...
 'formulas': [{'nombre': 'Ley de Coulomb',
               ...
               'sale_de': ['Experimentalmente, la fuerza es proporcional al producto de las cargas.',
               ...
               'despejes': ['q1 = F r^2 / (k |q2|)',
                            'q2 = F r^2 / (k |q1|)',
                            'r = sqrt(k |q1 q2| / F)',
                            'k = F r^2 / |q1 q2|',
                            'epsilon_r = k |q1 q2| / (F r^2) si F=(k/epsilon_r)|q1q2|/r^2'],
               'formulas_relacionadas': ['E = F/q0', 'E = k |q|/r^2', 'F = qE', 'U = k q1 q2/r'],
               'uso': 'Se usa para encontrar la fuerza entre dos cargas puntuales.',
               'cuando_usarla': ['Cuando el problema habla de dos cargas separadas una distancia.',
               ...
               'procedimiento': ['Convierte cargas a C y distancias a m.',
               ...
               'detalles': ['La fuerza sobre q1 y la fuerza sobre q2 tienen el mismo módulo y sentidos opuestos.',
                            'La fórmula con valor absoluto da módulo; el signo se usa para dirección.',
                            'En un medio material puede aparecer epsilon_r.'],
               'errores_tipicos': ['No convertir cm a m.',
                                   'No convertir μC a C.',
                                   'Usar r en vez de r².',
                                   'Decir atracción/repulsión sin mirar signos.'],
               'mini_ejemplo': {'enunciado': 'q1=+1 μC, q2=+2.5 μC, r=5 cm. Calcula F.',
                                'pasos': ['q1=1e-6 C, q2=2.5e-6 C, r=0.05 m.',
                                          'F=9e9(1e-6)(2.5e-6)/(0.05)^2.',
                                          'F=9 N.',
                                          'Como ambas son positivas, se repelen.'],
                                'resultado': 'F=9 N, repulsiva.'},
               'latex_base': '$F = k\\frac{|q_1q_2|}{r^2}$',
               'latex_principal': '$F = \\frac{1}{4\\pi\\varepsilon_0}\\frac{|q_1q_2|}{r^2}$',
               'latex_despejes': ['$r = \\sqrt{\\frac{k|q_1q_2|}{F}}$',
                                  '$q_1 = \\frac{Fr^2}{k|q_2|}$',
                                  '$k = \\frac{Fr^2}{|q_1q_2|}$']},
              {'nombre': 'Fuerza eléctrica resultante por superposición',
               ...
               'sale_de': ['Cada carga ejerce su propia fuerza sobre la carga estudiada.',
                           'La interacción eléctrica cumple superposición.',
                           'Como la fuerza es vector, se suman componentes.'],
               'despejes': ['F_total = sqrt(F_x^2 + F_y^2)',
                            'theta = atan(F_y/F_x)',
                            'F_x = F cos(theta)',
                            'F_y = F sin(theta)'],
               'formulas_relacionadas': ['F = k |q1 q2|/r^2', 'E_total = E_1 + E_2 + ...', 'E_x = ΣE_x, E_y = ΣE_y'],
               'uso': 'Resolver problemas de tres o más cargas donde piden fuerza neta.',
               'cuando_usarla': ['Cuando una carga recibe fuerza de varias cargas.',
                                 'Cuando el enunciado dice fuerza resultante.',
                                 'Cuando hay triángulos o geometría 2D.'],
               'procedimiento': ['Elige la carga sobre la que actúan las fuerzas.',
               ...
               'errores_tipicos': ['Sumar módulos directamente aunque las fuerzas no estén alineadas.',
                                   'Olvidar que una fuerza atractiva apunta hacia la otra carga.',
                                   'Equivocarse con seno/coseno al descomponer.'],
               'latex_base': '$\\vec F_{\\mathrm{total}}=\\vec F_1+\\vec F_2+\\cdots$',
               'latex_principal': '$F_x=\\sum F_{i,x},\\qquad F_y=\\sum F_{i,y}$',
               'latex_despejes': ['$|\\vec F|=\\sqrt{F_x^2+F_y^2}$',
              ...
              {'nombre': 'Definición de campo eléctrico',
               ...
               'sale_de': ['Se introduce una carga de prueba q0 pequeña y positiva.',
                           'Se mide la fuerza F que sentiría.',
                           'El campo se define como E=F/q0 para describir el efecto de las cargas fuente sin depender '
                           'de q0.'],
               'despejes': ['F = q0 E', 'q0 = F/E', 'E = F/q0'],
               'formulas_relacionadas': ['E = k |q|/r²', 'F = k |q q0|/r²', 'E_total = ΣE_i'],
               'uso': 'Relacionar fuerza y campo eléctrico.',
               'cuando_usarla': ['Cuando ya conoces E y te piden fuerza sobre una carga.',
                                 'Cuando conoces F y q y te piden E.',
                                 'Cuando quieres distinguir campo producido por fuentes y fuerza sobre una carga '
                                 'concreta.'],
               'procedimiento': ['Identifica si la carga que te dan es fuente o carga de prueba.',
                                 'Si te piden fuerza sobre q, usa F=qE.',
                                 'Si q es negativa, la fuerza va en sentido contrario a E.'],
               'errores_tipicos': ['Confundir E con F.',
               ...
               'latex_base': '$\\vec E=\\frac{\\vec F}{q_0}$',
               'latex_principal': '$\\vec F=q\\vec E$',
               'latex_despejes': ['$q=\\frac{F}{E}$', '$E=\\frac{F}{q_0}$']},
              {'nombre': 'Campo eléctrico de una carga puntual',
               ...
               'sale_de': ['La fuerza de Coulomb entre q y una carga de prueba q0 es F=k|q q0|/r².',
                           'Por definición, E=F/q0.',
                           'Al dividir por q0 queda E=k|q|/r².'],
               'despejes': ['q = E r²/k', 'r = sqrt(k |q|/E)', 'k = E r²/|q|'],
               'formulas_relacionadas': ['F = q0 E', 'F = k |q q0|/r²', 'V = k q/r'],
               'uso': 'Calcular el campo creado por una carga puntual.',
               'cuando_usarla': ['Cuando hay una carga fuente y un punto de observación.',
                                 'Cuando te piden campo debido a una carga.',
                                 'Cuando luego debes sumar campos de varias cargas.'],
               'procedimiento': ['Dibuja la carga y el punto.',
                                 'Calcula r.',
                                 'Calcula módulo E=k|q|/r².',
                                 'Decide dirección: sale de +, entra en -.'],
               'detalles': ['El campo no depende de la carga de prueba.',
                            'El signo de q decide la dirección.',
                            'El módulo siempre es positivo.'],
               'errores_tipicos': ['Usar q0 además de q en la fórmula del campo.',
                                   'Sumar campos sin componentes.',
                                   'Olvidar que el campo de una carga negativa apunta hacia la carga.'],
               'latex_base': '$\\vec E=\\frac{\\vec F}{q_0}$',
               'latex_principal': '$E=k\\frac{|q|}{r^2}$',
               'latex_despejes': ['$q=\\frac{Er^2}{k}$', '$r=\\sqrt{\\frac{k|q|}{E}}$']},
              {'nombre': 'Campo eléctrico total por varias cargas',
               ...
               'sale_de': ['Cada carga produce un campo en el punto.',
                           'Los campos cumplen superposición.',
                           'Como E es vector, se suman componentes.'],
               'despejes': ['E_total_x = ΣE_ix',
                            'E_total_y = ΣE_iy',
                            '|E_total| = sqrt(E_x² + E_y²)',
                            'theta = atan(E_y/E_x)'],
               'formulas_relacionadas': ['E = k|q|/r²', 'F = q0 E_total', 'V_total = ΣV_i'],
               'uso': 'Calcular campo neto en un punto debido a varias cargas.',
               'cuando_usarla': ['Cuando hay dos o más cargas.',
                                 'Cuando el punto P recibe campos de varias fuentes.',
                                 'Cuando aparece una configuración con simetría.'],
               'procedimiento': ['Calcula el campo de cada carga en P.',
                                 'Dibuja la dirección de cada E.',
                                 'Descompón en componentes.',
                                 'Suma componentes.',
                                 'Calcula módulo y dirección final.'],
               'errores_tipicos': ['Sumar módulos aunque los vectores tengan direcciones distintas.',
                                   'Confundir campo con potencial.',
                                   'No aprovechar simetría para cancelar componentes.'],
               'latex_base': '$\\vec E_{\\mathrm{total}}=\\vec E_1+\\vec E_2+\\cdots$',
               'latex_principal': '$\\vec E_{\\mathrm{total}}=\\sum_i k\\frac{q_i}{r_i^2}\\hat r_i$',
               'latex_despejes': ['$E_x=\\sum E_{i,x}$', '$E_y=\\sum E_{i,y}$', '$|\\vec E|=\\sqrt{E_x^2+E_y^2}$']},
              {'nombre': 'Campo nulo entre o alrededor de cargas',
               ...
               'sale_de': ['Para que el campo neto sea cero, los campos deben tener igual módulo y sentidos opuestos.',
                           'En una línea, se pueden igualar módulos si ya decidiste la región correcta.',
                           'La constante k suele cancelarse.'],
               'despejes': ['|q1|/r1² = |q2|/r2²', 'sqrt(|q1|)/r1 = sqrt(|q2|)/r2', 'r1/r2 = sqrt(|q1|/|q2|)'],
               'formulas_relacionadas': ['E = k|q|/r²', 'F_total = 0', 'Superposición vectorial'],
               'uso': 'Encontrar puntos donde el campo eléctrico se anula.',
               'cuando_usarla': ['Cuando el enunciado dice punto donde el campo es cero.',
                                 'Cuando hay dos cargas en un eje.',
                                 'Cuando se busca equilibrio eléctrico de una carga de prueba.'],
               'procedimiento': ['Divide el eje en regiones.',
               ...
               'errores_tipicos': ['Igualar módulos sin comprobar direcciones.',
                                   'Elegir la región incorrecta.',
                                   'Olvidar que entre cargas iguales del mismo signo sí puede haber cancelación.'],
               'latex_base': '$\\vec E_{\\mathrm{total}}=0$',
               'latex_principal': '$k\\frac{|q_1|}{r_1^2}=k\\frac{|q_2|}{r_2^2}$',
               'latex_despejes': ['$\\frac{|q_1|}{r_1^2}=\\frac{|q_2|}{r_2^2}$',
              ...
              {'nombre': 'Potencial eléctrico de una carga puntual',
               ...
               'sale_de': ['El potencial se define como energía potencial por unidad de carga.',
                           'La energía potencial de dos cargas puntuales es U=k q q0/r.',
                           'Al dividir por q0 queda V=kq/r.'],
               'despejes': ['q = V r/k', 'r = k q/V', 'U = q0 V', 'Delta U = q0 Delta V'],
               'formulas_relacionadas': ['U = qV', 'E = k|q|/r²', 'W_campo = -Delta U', 'V_total = ΣV_i'],
               'uso': 'Calcular potencial creado por una carga puntual.',
               'cuando_usarla': ['Cuando te piden potencial en un punto.',
                                 'Cuando hay varias cargas y quieres sumar escalares.',
                                 'Cuando luego necesitas energía o trabajo.'],
               'procedimiento': ['Calcula distancia r desde la carga al punto.',
                                 'Usa V=kq/r con signo de q.',
                                 'Si hay varias cargas, suma algebraicamente cada V.'],
               'detalles': ['El potencial puede ser positivo, negativo o cero.',
                            'No tiene dirección.',
                            'Es más sencillo que el campo porque no requiere componentes.'],
               'errores_tipicos': ['Usar valor absoluto de q cuando el signo sí importa.',
                                   'Intentar descomponer potencial en componentes.',
                                   'Confundir V de potencial con V de voltaje en circuitos; físicamente están '
                                   'conectados, pero el contexto importa.'],
               'latex_base': '$V=\\frac{U}{q_0}$',
               'latex_principal': '$V=k\\frac{q}{r}$',
               'latex_despejes': ['$q=\\frac{Vr}{k}$', '$r=\\frac{kq}{V}$', '$U=q_0V$']},
              {'nombre': 'Potencial total por varias cargas',
               ...
               'sale_de': ['El potencial es escalar.',
                           'Cada carga contribuye con V_i=kq_i/r_i.',
                           'La superposición escalar permite sumar directamente con signos.'],
               'despejes': ['V_total = k(q1/r1 + q2/r2 + ...)', 'Si V_total=0: Σ q_i/r_i = 0', 'U = q0 V_total'],
               'formulas_relacionadas': ['V = kq/r', 'U = qV', 'E_total = ΣE_i'],
               'uso': 'Calcular potencial neto en un punto por varias cargas.',
               'cuando_usarla': ['Cuando hay varias cargas y te piden potencial.',
                                 'Cuando te piden energía de una carga en ese punto.',
                                 'Cuando buscas puntos de potencial cero.'],
               'procedimiento': ['Calcula r_i desde cada carga hasta el punto.',
                                 'Calcula V_i=kq_i/r_i con su signo.',
                                 'Suma todos los V_i.'],
               'errores_tipicos': ['Sumar potencial como vector.',
                                   'Ignorar signos de cargas negativas.',
                                   'Confundir punto donde V=0 con punto donde E=0.'],
               'latex_base': '$V_{\\mathrm{total}}=V_1+V_2+\\cdots$',
               'latex_principal': '$V_{\\mathrm{total}}=\\sum_i k\\frac{q_i}{r_i}$',
               'latex_despejes': ['$V_{\\mathrm{total}}=k\\left(\\frac{q_1}{r_1}+\\frac{q_2}{r_2}+\\cdots\\right)$',
                                  '$U=q_0V_{\\mathrm{total}}$']},
              {'nombre': 'Energía potencial eléctrica de dos cargas',
               ...
               'sale_de': ['El potencial creado por q1 en la posición de q2 es V=kq1/r.',
                           'La energía de q2 en ese potencial es U=q2V.',
                           'Entonces U=kq1q2/r.'],
               'despejes': ['q1 = U r/(k q2)', 'q2 = U r/(k q1)', 'r = k q1 q2/U', 'Delta U = q Delta V'],
               'formulas_relacionadas': ['V = kq/r', 'U = qV', 'W_campo = -Delta U'],
               'uso': 'Resolver problemas de energía y trabajo con cargas puntuales.',
               'cuando_usarla': ['Cuando te piden trabajo para acercar o separar cargas.',
                                 'Cuando hay energía potencial eléctrica.',
                                 'Cuando comparas posiciones inicial y final.'],
               'procedimiento': ['Calcula U_i y U_f.',
                                 'Calcula Delta U=U_f-U_i.',
                                 'Trabajo del campo: W_campo=-Delta U.',
                                 'Trabajo externo lento: W_ext=Delta U.'],
               'errores_tipicos': ['Usar valor absoluto cuando el signo de U importa.',
                                   'Confundir trabajo del campo con trabajo externo.',
                                   'Olvidar que cargas opuestas tienen U negativa.'],
               'latex_base': '$U=qV$',
               'latex_principal': '$U=k\\frac{q_1q_2}{r}$',
               'latex_despejes': ['$r=\\frac{kq_1q_2}{U}$', '$\\Delta U=U_f-U_i$']},
              {'nombre': 'Trabajo eléctrico y diferencia de potencial',
               ...
               'cuando_usarla': ['Cuando se mueve una carga entre dos puntos.',
                                 'Cuando preguntan trabajo del campo o de un agente externo.',
                                 'Cuando aparece diferencia de potencial.'],
               'procedimiento': ['Identifica punto inicial y final.',
                                 'Calcula Delta V=V_f-V_i.',
                                 'Calcula Delta U=qDelta V.',
                                 'Decide si piden trabajo del campo o trabajo externo.'],
               'errores_tipicos': ['Cambiar el signo de Delta V.',
                                   'Confundir W_campo con W_externo.',
                                   'Olvidar el signo de q.'],
               'latex_base': '$\\Delta U=q\\Delta V$',
               'latex_principal': '$W_{\\mathrm{campo}}=-q\\Delta V$',
               'latex_despejes': ['$\\Delta V=\\frac{\\Delta U}{q}$', '$W_{\\mathrm{ext}}=q\\Delta V$']},
              {'nombre': 'Relación entre campo eléctrico y potencial uniforme',
               ...
               'sale_de': ['El campo eléctrico apunta hacia donde el potencial disminuye.',
                           'En una dimensión, E_x = -dV/dx.',
                           'Si E es uniforme, la derivada se convierte en cociente: E=-Delta V/Delta x.'],
               'despejes': ['Delta V = -E d', 'E = |Delta V|/d', 'd = |Delta V|/E'],
               'formulas_relacionadas': ['F=qE',
                                         'Delta U=qDelta V',
               ...
               'cuando_usarla': ['Cuando el problema menciona placas paralelas.',
                                 'Cuando el campo es uniforme.',
                                 'Cuando dan voltaje y separación.'],
               'procedimiento': ['Identifica la dirección del campo.',
               ...
               'errores_tipicos': ['Olvidar el signo menos conceptual.',
                                   'Confundir distancia total con desplazamiento en dirección del campo.',
                                   'Usar esta fórmula en un campo no uniforme sin cuidado.'],
               'latex_base': '$E=-\\frac{\\Delta V}{\\Delta s}$',
               'latex_principal': '$\\Delta V=-Ed$',
               'latex_despejes': ['$E=\\frac{|\\Delta V|}{d}$', '$d=\\frac{|\\Delta V|}{E}$']},
              {'nombre': 'Flujo eléctrico',
               ...
               'sale_de': ['El flujo cuenta la componente del campo perpendicular a la superficie.',
                           'Para campo uniforme y área plana, la componente normal es E cos(theta).',
                           'Entonces Phi=EAcos(theta).'],
               'despejes': ['E = Phi_E/(A cos(theta))', 'A = Phi_E/(E cos(theta))', 'cos(theta)=Phi_E/(EA)'],
               'formulas_relacionadas': ['Ley de Gauss: Phi_E=Q_enc/epsilon_0', 'E = kq/r²', 'Área esfera: A=4πr²'],
               'uso': 'Calcular flujo a través de una superficie.',
               'cuando_usarla': ['Cuando el enunciado habla de superficie y campo uniforme.',
                                 'Cuando te piden líneas de campo atravesando un área.',
                                 'Antes de aplicar Gauss.'],
               'procedimiento': ['Identifica el vector normal a la superficie.',
                                 'Determina el ángulo theta entre E y la normal.',
                                 'Usa Phi=EAcos(theta).',
                                 'Aplica signo si la orientación importa.'],
               'detalles': ['Si E es paralelo a la superficie, no atraviesa la superficie: flujo cero.',
                            'Si E es perpendicular a la superficie, flujo máximo.',
                            'La unidad es N m²/C.'],
               'errores_tipicos': ['Usar el ángulo con la superficie en vez del ángulo con la normal.',
                                   'Olvidar que el flujo puede ser negativo.',
                                   'Confundir área real con área proyectada.'],
               'latex_base': '$\\Phi_E=EA\\cos\\theta$',
               'latex_principal': '$\\Phi_E=\\int \\vec E\\cdot d\\vec A$',
               'latex_despejes': ['$E=\\frac{\\Phi_E}{A\\cos\\theta}$', '$\\cos\\theta=\\frac{\\Phi_E}{EA}$']},
              {'nombre': 'Ley de Gauss',
               ...
               'sale_de': ['Para una carga puntual, E=kq/r².',
               ...
               'despejes': ['Q_enc = epsilon_0 Phi_E',
               ...
               'errores_tipicos': ['Usar Q total en vez de Q encerrada.',
               ...
               'latex_base': '$\\Phi_E=\\frac{Q_{\\mathrm{enc}}}{\\varepsilon_0}$',
               'latex_principal': '$\\oint \\vec E\\cdot d\\vec A=\\frac{Q_{\\mathrm{enc}}}{\\varepsilon_0}$',
               'latex_despejes': ['$Q_{\\mathrm{enc}}=\\varepsilon_0\\Phi_E$',
                                  '$E=\\frac{Q_{\\mathrm{enc}}}{\\varepsilon_0A}$']},
              {'nombre': 'Campo de una esfera/carga con simetría esférica',
               'idea_clave': 'Fuera de una distribución esférica, el campo se comporta como si toda la carga estuviera '
                             'en el centro.',
               'formula_base': '∮E·dA = Q_enc/epsilon_0',
               'formula_principal': 'E = Q_enc/(4πepsilon_0 r²)',
               'sale_de': ['Se elige una superficie gaussiana esférica de radio r.',
               ...
               'despejes': ['Q_enc = E 4πepsilon_0 r²', 'r = sqrt(Q_enc/(4πepsilon_0 E))'],
               'formulas_relacionadas': ['E = kQ/r²', 'k = 1/(4πepsilon_0)', 'Phi_E = Q_enc/epsilon_0'],
               'uso': 'Esferas cargadas, cargas puntuales, cortezas esféricas y conductores esféricos.',
               'cuando_usarla': ['Cuando la distribución tiene simetría esférica.',
                                 'Cuando se pide E a distancia r del centro.',
                                 'Cuando una esfera conductora se trata desde fuera.'],
               'procedimiento': ['Distingue si el punto está dentro o fuera.',
                                 'Calcula Q_enc para ese radio.',
                                 'Usa E(4πr²)=Q_enc/epsilon_0.',
                                 'Despeja E.'],
               'errores_tipicos': ['Usar carga total aunque el punto esté dentro de una distribución volumétrica.',
                                   'No distinguir conductor de aislante uniformemente cargado.',
                                   'Olvidar que dentro de un conductor en equilibrio E=0.'],
               'latex_base': '$\\oint \\vec E\\cdot d\\vec A=\\frac{Q_{\\mathrm{enc}}}{\\varepsilon_0}$',
               'latex_principal': '$E=\\frac{Q_{\\mathrm{enc}}}{4\\pi\\varepsilon_0r^2}$',
               'latex_despejes': ['$Q_{\\mathrm{enc}}=4\\pi\\varepsilon_0r^2E$', '$E=k\\frac{Q}{r^2}$']},
              {'nombre': 'Campo de línea infinita de carga',
               ...
               'sale_de': ['La simetría cilíndrica indica que E es radial y depende solo de r.',
               ...
               'despejes': ['lambda = E 2πepsilon_0 r', 'r = lambda/(2πepsilon_0 E)'],
               'formulas_relacionadas': ['Q=lambda L', 'Área lateral cilindro=2πrL', 'Ley de Gauss'],
               'uso': 'Campo eléctrico de líneas largas de carga.',
               'cuando_usarla': ['Cuando el enunciado dice línea infinita o cable largo cargado.',
                                 'Cuando hay simetría cilíndrica.',
                                 'Cuando te dan densidad lineal lambda.'],
               'procedimiento': ['Escoge cilindro coaxial con la línea.',
                                 'Calcula Q_enc=lambda L.',
                                 'Usa solo el área lateral para el flujo.',
                                 'Despeja E.'],
               'errores_tipicos': ['Usar área de esfera en vez de cilindro.',
                                   'Incluir flujo por las tapas.',
                                   'Confundir lambda con densidad superficial sigma.'],
               'latex_base': '$\\oint \\vec E\\cdot d\\vec A=\\frac{Q_{\\mathrm{enc}}}{\\varepsilon_0}$',
               'latex_principal': '$E=\\frac{\\lambda}{2\\pi\\varepsilon_0r}$',
               'latex_despejes': ['$\\lambda=2\\pi\\varepsilon_0rE$', '$Q=\\lambda L$']},
              {'nombre': 'Campo de plano infinito cargado',
               ...
               'sale_de': ['La simetría indica que E es perpendicular al plano por ambos lados.',
               ...
               'despejes': ['sigma = 2epsilon_0 E',
                            'E = sigma/(2epsilon_0)',
                            'Para conductor justo fuera: E=sigma/epsilon_0'],
               'formulas_relacionadas': ['Phi_E = Q_enc/epsilon_0',
                                         'Q=sigma A',
              ...
              {'nombre': 'Conductor en equilibrio electrostático',
               ...
               'sale_de': ['Si hubiera campo dentro del conductor, las cargas libres se moverían.',
                           'En equilibrio, las cargas ya no se mueven; por tanto E interior debe ser cero.',
                           'Usando Gauss en una caja pequeña que atraviesa la superficie, se obtiene E=sigma/epsilon_0 '
                           'justo fuera.'],
               'despejes': ['sigma = epsilon_0 E',
                            'Phi_E interior = 0 si no hay carga encerrada en cavidad',
                            'V constante en el conductor'],
               'formulas_relacionadas': ['Ley de Gauss', 'E = -dV/ds', 'Superficie equipotencial'],
               'uso': 'Problemas de conductores, esferas conductoras, cavidades y equilibrio electrostático.',
               'cuando_usarla': ['Cuando se menciona conductor en equilibrio.',
                                 'Cuando te preguntan campo dentro de un conductor.',
                                 'Cuando se pregunta dónde queda la carga neta.'],
               'procedimiento': ['Escribe E=0 dentro del conductor.',
               ...
               'errores_tipicos': ['Pensar que dentro de una esfera conductora cargada hay campo.',
                                   'Confundir conductor con aislante uniformemente cargado.',
                                   'Olvidar que el campo externo es perpendicular a la superficie.'],
               'latex_base': '$E_{\\mathrm{interior}}=0$',
               'latex_principal': '$E_{\\mathrm{fuera}}=\\frac{\\sigma}{\\varepsilon_0}$',
               'latex_despejes': ['$\\sigma=\\varepsilon_0E$',
                                  '$V=\\mathrm{constante}\\quad\\mathrm{en\\ el\\ conductor}$']}],
 'interpretacion_enunciados': [{'palabra_clave': 'dos cargas separadas',
                                'que_significa': 'Normalmente piden fuerza eléctrica por Ley de Coulomb.',
                                'que_suele_pedir': ['Módulo de la fuerza.',
                                                    'Si la fuerza es atractiva o repulsiva.',
                                                    'Distancia necesaria para una fuerza dada.',
                                                    'Carga desconocida.',
                                                    'Permitividad relativa del medio.'],
                                'operaciones_recomendadas': ['Convierte todas las unidades a SI.',
                                                             'Usa F=k|q1q2|/r².',
                               ...
                               {'palabra_clave': 'fuerza resultante sobre una carga',
                                ...
                                'que_suele_pedir': ['Fuerza neta.',
                                                    'Componentes de la fuerza.',
                                                    'Módulo y dirección final.',
                                                    'Equilibrio de una carga.'],
                                'operaciones_recomendadas': ['Elige la carga sobre la que actúan las fuerzas.',
                               ...
                               {'palabra_clave': 'campo eléctrico en un punto',
                                'que_significa': 'Te piden E en un punto del espacio, no fuerza sobre una carga '
                                                 'necesariamente.',
                                'que_suele_pedir': ['Campo debido a una carga.',
                                                    'Campo total por varias cargas.',
                                                    'Punto donde el campo se anula.',
                                                    'Dirección del campo.'],
                                'operaciones_recomendadas': ['Calcula E de cada carga.',
                               ...
                               {'palabra_clave': 'superficie cerrada / carga encerrada',
                                ...
                                'que_suele_pedir': ['Flujo total.',
                                                    'Carga encerrada.',
                                                    'Campo con simetría.',
                                                    'Campo en conductores.'],
                                'operaciones_recomendadas': ['Identifica Q_enc.',
                               ...
                               {'palabra_clave': 'esfera / cilindro / plano infinito',
                                ...
                                'que_suele_pedir': ['Campo eléctrico en función de r.',
                                                    'Campo dentro/fuera.',
                                                    'Carga encerrada.',
                                                    'Densidad de carga.'],
                                'operaciones_recomendadas': ['Esfera: superficie gaussiana esférica.',
                                                             'Cilindro/línea: superficie gaussiana cilíndrica.',
                                                             'Plano: caja gaussiana tipo píldora.',
                                                             'Calcula Q_enc según la región.'],
                                'pista_examen': 'La superficie gaussiana se elige para que el flujo sea fácil, no '
                                                'porque sea una superficie física.'},
                               {'palabra_clave': 'conductor en equilibrio',
                                'que_significa': 'Las cargas libres ya se acomodaron y no se mueven.',
                                'que_suele_pedir': ['Campo dentro del conductor.',
                                                    'Dónde está la carga neta.',
                                                    'Potencial del conductor.',
                                                    'Campo justo fuera de la superficie.'],
                                'operaciones_recomendadas': ['Escribe E=0 dentro del conductor.',
                                                             'Indica que la carga neta queda en la superficie.',
                                                             'La superficie es equipotencial.',
                                                             'El campo externo es perpendicular a la superficie.'],
                                'pista_examen': 'Si el conductor está en equilibrio electrostático, el campo dentro '
                                                'del material conductor es cero.'}],
 'flashcards': [{'id': 'fis1_fc_001',
                 'frente': '¿Qué pasa con dos cargas del mismo signo?',
                 'reverso': 'Se repelen.',
                 'categoria': 'Carga eléctrica'},
                {'id': 'fis1_fc_002',
                 'frente': '¿Qué pasa con dos cargas de signo opuesto?',
                 'reverso': 'Se atraen.',
                 'categoria': 'Carga eléctrica'},
                {'id': 'fis1_fc_003',
                 'frente': '¿Cuál es la fórmula de Coulomb?',
                 'reverso': 'F=k|q1q2|/r².',
                 'categoria': 'Coulomb'},
                {'id': 'fis1_fc_004',
                 'frente': '¿Qué significa k en Coulomb?',
                 'reverso': 'La constante de Coulomb: k≈8.99e9 N·m²/C².',
                 'categoria': 'Coulomb'},
                {'id': 'fis1_fc_005',
                 'frente': '¿Qué debes hacer siempre antes de usar Coulomb?',
                 'reverso': 'Convertir cargas a C y distancias a m.',
                 'categoria': 'Unidades'},
                {'id': 'fis1_fc_006',
                 'frente': '¿El campo eléctrico es vector o escalar?',
                 'reverso': 'Vector.',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_007',
                 'frente': '¿El potencial eléctrico es vector o escalar?',
                 'reverso': 'Escalar.',
                 'categoria': 'Potencial'},
                {'id': 'fis1_fc_008',
                 'frente': '¿De dónde salen las líneas de campo eléctrico?',
                 'reverso': 'Salen de cargas positivas y entran en cargas negativas.',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_009',
                 'frente': '¿Definición de campo eléctrico?',
                 'reverso': 'E=F/q0.',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_010',
                 'frente': '¿Fuerza sobre una carga q en un campo E?',
                 'reverso': 'F=qE.',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_011',
                 'frente': '¿Campo creado por una carga puntual?',
                 'reverso': 'E=k|q|/r².',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_012',
                 'frente': 'Si q es negativa, ¿F=qE va en el mismo sentido que E?',
                 'reverso': 'No, va en sentido contrario.',
                 'categoria': 'Campo eléctrico'},
                {'id': 'fis1_fc_013',
                 'frente': '¿Cómo se suman campos eléctricos?',
                 'reverso': 'Vectorialmente, por componentes.',
                 'categoria': 'Superposición'},
                {'id': 'fis1_fc_014',
                 'frente': '¿Cómo se suman potenciales eléctricos?',
                 'reverso': 'Algebraicamente como escalares.',
                 'categoria': 'Potencial'},
                {'id': 'fis1_fc_015',
                 'frente': '¿Potencial de una carga puntual?',
                 'reverso': 'V=kq/r.',
                 'categoria': 'Potencial'},
                {'id': 'fis1_fc_016',
                 'frente': '¿Relación entre energía potencial y potencial?',
                 'reverso': 'U=qV.',
                 'categoria': 'Energía'},
                {'id': 'fis1_fc_017',
                 'frente': '¿Trabajo del campo eléctrico?',
                 'reverso': 'W_campo=-Delta U=-q Delta V.',
                 'categoria': 'Trabajo'},
                {'id': 'fis1_fc_018',
                 'frente': '¿Flujo eléctrico en campo uniforme?',
                 'reverso': 'Phi_E=EAcos(theta).',
                 'categoria': 'Flujo'},
                {'id': 'fis1_fc_019',
                 'frente': 'En flujo, ¿theta es con la superficie o con la normal?',
                 'reverso': 'Con la normal.',
                 'categoria': 'Flujo'},
                {'id': 'fis1_fc_020',
                 'frente': '¿Ley de Gauss?',
                 'reverso': 'Phi_E=Q_enc/epsilon_0.',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_021',
                 'frente': '¿Cuándo conviene usar Gauss?',
                 'reverso': 'Con simetría esférica, cilíndrica o plana.',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_022',
                 'frente': '¿Qué carga cuenta en Gauss?',
                 'reverso': 'La carga encerrada por la superficie cerrada.',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_023',
                 'frente': '¿Campo dentro de un conductor en equilibrio?',
                 'reverso': 'E=0.',
                 'categoria': 'Conductores'},
                {'id': 'fis1_fc_024',
                 'frente': '¿Dónde está la carga neta de un conductor en equilibrio?',
                 'reverso': 'En la superficie.',
                 'categoria': 'Conductores'},
                {'id': 'fis1_fc_025',
                 'frente': '¿La superficie de un conductor en equilibrio es equipotencial?',
                 'reverso': 'Sí.',
                 'categoria': 'Conductores'},
                {'id': 'fis1_fc_026',
                 'frente': '¿Campo de línea infinita de carga?',
                 'reverso': 'E=lambda/(2πepsilon_0 r).',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_027',
                 'frente': '¿Campo de plano infinito aislado?',
                 'reverso': 'E=sigma/(2epsilon_0).',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_028',
                 'frente': '¿Qué superficie gaussiana usas para una carga puntual?',
                 'reverso': 'Una esfera centrada en la carga.',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_029',
                 'frente': '¿Qué superficie gaussiana usas para una línea infinita?',
                 'reverso': 'Un cilindro coaxial.',
                 'categoria': 'Gauss'},
                {'id': 'fis1_fc_030',
                 'frente': '¿Qué superficie gaussiana usas para un plano infinito?',
                 'reverso': 'Una caja/píldora gaussiana.',
                 'categoria': 'Gauss'}],
 'preguntas_vf': [{'id': 'fis1_vf_001',
                   'pregunta': 'Cargas del mismo signo se atraen.',
                   'respuesta': False,
                   'explicacion': 'Cargas del mismo signo se repelen.',
                   'categoria': 'Carga eléctrica',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_002',
                   'pregunta': 'Cargas de signo opuesto se atraen.',
                   'respuesta': True,
                   'explicacion': 'Es la regla básica de interacción eléctrica.',
                   'categoria': 'Carga eléctrica',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_003',
                   'pregunta': 'La fuerza de Coulomb disminuye con r².',
                   'respuesta': True,
                   'explicacion': 'F es inversamente proporcional al cuadrado de la distancia.',
                   'categoria': 'Coulomb',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_004',
                   'pregunta': 'Si duplicas la distancia entre dos cargas, la fuerza se duplica.',
                   'respuesta': False,
                   'explicacion': 'Si r se duplica, F se divide entre 4.',
                   'categoria': 'Coulomb',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_005',
                   'pregunta': 'La fuerza eléctrica es una magnitud vectorial.',
                   'respuesta': True,
                   'explicacion': 'Tiene módulo, dirección y sentido.',
                   'categoria': 'Coulomb',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_006',
                   'pregunta': 'En una fuerza resultante, puedes sumar siempre solo los módulos.',
                   'respuesta': False,
                   'explicacion': 'Solo si las fuerzas están en la misma línea y con signos. En general se suman '
                                  'vectores.',
                   'categoria': 'Superposición',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_007',
                   'pregunta': 'El campo eléctrico se define como E=F/q0.',
                   'respuesta': True,
                   'explicacion': 'Es fuerza por unidad de carga de prueba positiva.',
                   'categoria': 'Campo eléctrico',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_008',
                   'pregunta': 'El campo de una carga positiva apunta hacia la carga.',
                   'respuesta': False,
                   'explicacion': 'Sale de la carga positiva.',
                   'categoria': 'Campo eléctrico',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_009',
                   'pregunta': 'El campo de una carga negativa apunta hacia la carga.',
                   'respuesta': True,
                   'explicacion': 'Las líneas de campo entran en cargas negativas.',
                   'categoria': 'Campo eléctrico',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_010',
                   'pregunta': 'Si una carga q negativa está en un campo E, la fuerza va en sentido contrario a E.',
                   'respuesta': True,
                   'explicacion': 'F=qE; si q<0, invierte dirección.',
                   'categoria': 'Campo eléctrico',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_011',
                   'pregunta': 'El potencial eléctrico es una magnitud vectorial.',
                   'respuesta': False,
                   'explicacion': 'El potencial es escalar.',
                   'categoria': 'Potencial',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_012',
                   'pregunta': 'Los potenciales de varias cargas se suman algebraicamente.',
                   'respuesta': True,
                   'explicacion': 'V es escalar, por eso se suman con signo.',
                   'categoria': 'Potencial',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_013',
                   'pregunta': 'El campo eléctrico y el potencial eléctrico se suman de la misma manera.',
                   'respuesta': False,
                   'explicacion': 'E se suma vectorialmente; V se suma escalarmente.',
                   'categoria': 'Potencial',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_014',
                   'pregunta': 'Un punto donde V=0 necesariamente tiene E=0.',
                   'respuesta': False,
                   'explicacion': 'Potencial cero y campo cero no son lo mismo.',
                   'categoria': 'Potencial',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_015',
                   'pregunta': 'La energía potencial eléctrica cumple U=qV.',
                   'respuesta': True,
                   'explicacion': 'Es la relación entre energía potencial y potencial.',
                   'categoria': 'Energía',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_016',
                   'pregunta': 'El trabajo del campo eléctrico es W_campo=-Delta U.',
                   'respuesta': True,
                   'explicacion': 'Para fuerzas conservativas, el trabajo del campo reduce la energía potencial.',
                   'categoria': 'Trabajo',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_017',
                   'pregunta': 'El flujo eléctrico usa el ángulo entre E y la superficie.',
                   'respuesta': False,
                   'explicacion': 'La fórmula usa el ángulo entre E y la normal a la superficie.',
                   'categoria': 'Flujo',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_018',
                   'pregunta': 'Si E es paralelo a una superficie plana, el flujo a través de ella es cero.',
                   'respuesta': True,
                   'explicacion': 'No atraviesa la superficie; theta con la normal es 90°.',
                   'categoria': 'Flujo',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_019',
                   'pregunta': 'La Ley de Gauss dice que el flujo neto depende de la carga encerrada.',
                   'respuesta': True,
                   'explicacion': 'Phi_E=Q_enc/epsilon_0.',
                   'categoria': 'Gauss',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_020',
                   'pregunta': 'Gauss solo es verdadera para esferas.',
                   'respuesta': False,
                   'explicacion': 'La ley es general; lo que cambia es si ayuda a despejar E fácilmente.',
                   'categoria': 'Gauss',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_021',
                   'pregunta': 'Para una línea infinita de carga conviene usar una superficie gaussiana cilíndrica.',
                   'respuesta': True,
                   'explicacion': 'La simetría es cilíndrica.',
                   'categoria': 'Gauss',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_022',
                   'pregunta': 'Para un plano infinito cargado, el campo depende de la distancia al plano.',
                   'respuesta': False,
                   'explicacion': 'Idealmente el campo de un plano infinito no depende de la distancia.',
                   'categoria': 'Gauss',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_023',
                   'pregunta': 'Dentro de un conductor en equilibrio electrostático, E=0.',
                   'respuesta': True,
                   'explicacion': 'Si hubiera campo, las cargas libres se moverían.',
                   'categoria': 'Conductores',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_024',
                   'pregunta': 'La carga neta de un conductor en equilibrio se queda en el volumen interior.',
                   'respuesta': False,
                   'explicacion': 'Se distribuye en la superficie.',
                   'categoria': 'Conductores',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_025',
                   'pregunta': 'La superficie de un conductor en equilibrio es equipotencial.',
                   'respuesta': True,
                   'explicacion': 'Si no lo fuera, habría campo tangencial y las cargas se moverían.',
                   'categoria': 'Conductores',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_026',
                   'pregunta': 'Si una superficie cerrada encierra carga neta cero, el flujo neto es cero.',
                   'respuesta': True,
                   'explicacion': 'Por Gauss, Phi=Q_enc/epsilon_0.',
                   'categoria': 'Gauss',
                   'dificultad': 'media'},
                  {'id': 'fis1_vf_027',
                   'pregunta': 'Flujo neto cero siempre significa campo eléctrico cero en toda la superficie.',
                   'respuesta': False,
                   'explicacion': 'Puede haber campo entrando y saliendo con flujo neto cero.',
                   'categoria': 'Gauss',
                   'dificultad': 'dificil'},
                  {'id': 'fis1_vf_028',
                   'pregunta': 'La fuerza eléctrica entre dos cargas cumple acción-reacción: mismos módulos y sentidos '
                               'opuestos.',
                   'respuesta': True,
                   'explicacion': 'Son fuerzas de interacción entre dos cuerpos.',
                   'categoria': 'Coulomb',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_029',
                   'pregunta': 'En el vacío, k≈9e9 N m²/C².',
                   'respuesta': True,
                   'explicacion': 'Es el valor aproximado habitual.',
                   'categoria': 'Coulomb',
                   'dificultad': 'facil'},
                  {'id': 'fis1_vf_030',
                   'pregunta': 'Si el medio tiene epsilon_r mayor que 1, la fuerza eléctrica disminuye respecto al '
                               'vacío.',
                   'respuesta': True,
                   'explicacion': 'En el modelo simple, F=(k/epsilon_r)|q1q2|/r².',
                   'categoria': 'Coulomb',
                   'dificultad': 'media'}],
 'preguntas_mc': [{'id': 'fis1_mc_001',
                  ...
                  {'id': 'fis1_mc_006',
                   ...
                   'opciones': ['Entra hacia la carga',
                                'Sale de la carga',
                                'Siempre es cero',
                                'Gira alrededor de la carga'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis1_mc_007',
                   ...
                   'opciones': ['Va en el mismo sentido que E',
                                'Va en sentido contrario a E',
                                'Siempre es cero',
                                'No depende de E'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis1_mc_008',
                   ...
                   'opciones': ['Sumar módulos siempre',
                                'Sumar vectorialmente',
                                'Sumar potenciales',
                                'Usar solo la carga más grande'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis1_mc_015',
                   ...
                   'opciones': ['No hay simetría',
                                'Hay simetría esférica/cilíndrica/plana',
                                'Hay una batería',
                                'Hay una resistencia'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis1_mc_016',
                   ...
                   'opciones': ['Cubo cualquiera',
                                'Esfera centrada en la carga',
                                'Cilindro desplazado',
                                'Plano abierto'],
                   'respuesta': 2,
                  ...
                  {'id': 'fis1_mc_023',
                   ...
                   'opciones': ['Diferencia de potencial',
                                'Solo en Coulomb',
                                'Ley de Ampère',
                  ...
                  {'id': 'fis1_mc_024',
                   ...
                   'opciones': ['E y V siempre son cero en el mismo punto',
                                'E es vector y V es escalar',
                                'V se suma por componentes',
                   ...
                   'dificultad': 'facil'},
                  {'id': 'fis1_mc_025',
                   'pregunta': 'Si el campo eléctrico es perpendicular a una superficie plana y sale en la dirección '
                               'de la normal, el flujo es:',
